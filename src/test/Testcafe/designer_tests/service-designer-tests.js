...
test('About page items and editing', async () => {
  ...
  await t
    .navigateTo(app.baseUrl + 'designer/AutoTest/testcafe01#/uieditor')
    .click(designer.omNavigationTab)
    .expect(designer.omTjenesteNavn.focused).notOk() 
    .click(designer.omTjenesteNavn)
    .typeText(designer.omTjenesteNavn, 'testcafe01' + '_' + randNumOne.toString())
    ...
    .pressKey('ctrl+a')
    .pressKey('backspace')
    .typeText(designer.omTjenesteNavn, 'testcafe01' + '_' + randNumTwo.toString())
    .expect(designer.omTjenesteNavn.getAttribute("value")).eql("testcafe01" + "_" + randNumTwo.toString())
