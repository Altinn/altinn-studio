/*
  ...
  [
    ...
    Command: docker-compose run k6 run src/tests/platform/storage/sblloadinstances_v1.js
...
export default function () {
  ...
  //Test to search for active instances for a party from storage: SBL and validate the response
  var queryModel = {
    language: 'nb',
  ...
  success = check(res, {
    'Search active Instance by Party status is 200': (r) => r.status === 200,
  });
