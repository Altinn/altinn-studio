/* 
  ...
  command to run the test: docker-compose run k6 run src/tests/app/negativetests/withoutallowedroles.js -e env=*** -e org=*** -e level1app=*** -e username=*** -e userpwd=*** -e level1user=***
*/
