...
public interface IKubernetesWrapperService
{
    ...
    public Task<IEnumerable<Log>> GetAppExceptions(string org, string env, int time, string? app, CancellationToken ct);
    ...
    /// <param name="org">The organization identifier.</param>
    /// <returns>The task result contains a list of running applications.</returns>
    public Task<IEnumerable<Log>> GetAppFailedRequests(string org, string env, int time, string? app, CancellationToken ct);
