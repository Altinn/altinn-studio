...
export const instance: IExtendedInstance = {
  instance: {
    title: {
      nb: 'title',
    },
...
export const instanceWithPdf: IExtendedInstance = {
  ...instance,
  instance: {
    ...instance.instance,
    data: [
...
export const instanceWithSubstatus: IExtendedInstance = {
  ...instance,
  instance: {
    ...instance.instance,
    status: {
