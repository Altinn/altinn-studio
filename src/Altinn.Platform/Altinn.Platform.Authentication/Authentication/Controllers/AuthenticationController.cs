...
namespace Altinn.Platform.Authentication.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        public async Task<ActionResult> Get(string goTo)
        {
            ...
            {
                _logger.LogInformation($" // 1936 debug // Didn't fint {_generalSettings.GetSBLCookieName} cookie in context.");
                return Redirect($"{_generalSettings.GetSBLRedirectEndpoint}?goTo={encodedGoToUrl}");
            }
            else
            {
                _logger.LogInformation($"// 1936 debug // Found {_generalSettings.GetSBLCookieName} cookie in context.");
                ...
                _logger.LogInformation($"// 1936 debug // Successfully created serializer for UserAuthenticationModel.");
                ...
                using (HttpClient client = new HttpClient())
                {
                    ...
                    _logger.LogInformation($"// 1936 debug // Serializing object with encrypted ticket");
                    ...
                    _logger.LogInformation($"// 1936 debug // Received response from server {response}");
