...
namespace Altinn.Platform.Authentication.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        /// <summary>
        /// Action for converting a JWT generated by a trusted token provider with a new JWT for further use as authentication against rest of Altinn.
        /// </summary>
        /// <returns>The result of the action. Contains the new token if the old token was valid and could be converted.</returns>
        [AllowAnonymous]
        [HttpGet("convert/{tokenProvider}")]
        public async Task<ActionResult> AuthenticateExternalSystemToken(string tokenProvider, [FromQuery] bool test)
        {
