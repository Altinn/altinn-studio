using System;
using System.Net;
using Altinn.Platform.Event.Health;
...
namespace Altinn.Platform.Event
{
        /// <summary>
    /// Config startup.
    /// </summary>
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                builder
                    .AddFilter("Altinn.Platform.Event.Startup", LogLevel.Debug)
                    .AddConsole();
            });
            ...
            services.AddHealthChecks().AddCheck<HealthCheck>("event_health_check");
