    ...
    public partial class IntegrationTests {
        ...
        public class TextControllerTests : IClassFixture<WebApplicationFactory<Startup>>
        {
            ...
            public TextControllerTests(WebApplicationFactory<Startup> factory)
            {
                ...
                _httpClient = CreateTestHttpClient(_mockTextRepository.Object);
            }
            ...
            public async void Create_ReturnsOK()
            {
                ...
                HttpResponseMessage response = await _httpClient.PostAsync(
                    requestUri,
                    new StringContent(JsonConvert.SerializeObject(GetValidTextResource()),
                    Encoding.UTF8,
                    "application/json"));
            ...
            /// <summary>
            /// Scenario:
            ///   Tries to create a text resource that allready exists
            /// Expected result:
            ...
            /// </summary>
            [Fact]
            public async void CreateWhereResourceAllreadyExists_ReturnsConflict()
            {
                string org = "testOrg";
                string app = "testApp";
                string requestUri = $"{BasePath}/{org}/{app}/texts";
                ...
                HttpResponseMessage response = await _httpClient.PostAsync(
                    requestUri,
                    new StringContent(JsonConvert.SerializeObject(GetTextResourceThatAllreadyExists()),
                    Encoding.UTF8,
                    "application/json"));
            ...
            private TextResource GetTextResourceThatAllreadyExists()
            {
                return new TextResource {
                    Language = "en",
                    Resources = new List<TextResourceElement> {
