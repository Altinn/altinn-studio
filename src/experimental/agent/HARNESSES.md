...
| Archive mid-turn, then unarchive and attach                              | The harness stops once the turn ends; attaching after unarchive resumes the conversation.                                                                                                                      |
| Idle Session whose transcript is older than 30 days                      | After a prompt in another Session of the Agent, it still resumes with its history. Backdate the transcript with `touch -d`.                                                                                    |
