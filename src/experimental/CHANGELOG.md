...
- A harness installation may be declared `optional`, so an Agent is created without it when its host
  login is absent. Altinn Agents declare Codex this way; `agentctl codex login` then installs it.
