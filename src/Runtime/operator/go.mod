...
require (
	...
	github.com/fluxcd/flux2/v2 v2.4.0 // indirect
	...
	github.com/fluxcd/pkg/oci v0.42.0 // indirect
	github.com/fluxcd/pkg/sourceignore v0.9.0 // indirect
	github.com/fluxcd/pkg/tar v0.9.0 // indirect
