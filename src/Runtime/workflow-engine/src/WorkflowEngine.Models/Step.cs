...
public sealed record Step : PersistentItem
{
    ...
    /// Generated by the engine when an AppCommand is immediately followed by a ReplyAppCommand
    /// with a matching CommandKey. The app uses this ID to POST replies back to the engine.
    /// </summary>
