...
const MOON_SVG =
    '<path d="M12 3a9 9 0 1 0 9 9c0-.46-.04-.92-.1-1.36a5.39 5.39 0 0 1-4.4 2.26 5.4 5.4 0 0 1-3.14-9.8A9.06 9.06 0 0 0 12 3z"/>';
const SUN_SVG =
...
export const bindThemeCallbacks = (fns) => {
    _syncUrl = fns.syncUrl;
};

/** @type {() => void} */
export const toggleTheme = () => {
    setTheme(getTheme() === 'altinn' ? '' : 'altinn');
    _syncUrl();
};
