...
public abstract class EngineAppFixture : IAsyncLifetime
{
    ...
    public async Task Reset()
    {
        ...
        await context.Database.ExecuteSqlRawAsync(
            "TRUNCATE engine.workflows, engine.steps, engine.workflow_collections, engine.idempotency_keys, engine.mailboxes, engine.mailbox_deliveries, engine.mailbox_waiters CASCADE"
        );
