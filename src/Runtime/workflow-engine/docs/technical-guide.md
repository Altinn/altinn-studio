...
- [Workflow Engine — Technical Guide](#workflow-engine--technical-guide)
  ...
  - [Command System](#command-system)
    ...
    - [Built-in: WebhookCommand](#built-in-webhookcommand)
  ...
  - [Dependency Graphs](#dependency-graphs)
    - [Within a Single Request (DAG)](#within-a-single-request-dag)
  ...
  - [API Reference](#api-reference)
    - [Enqueue Workflows](#enqueue-workflows)
    - [Get Single Workflow](#get-single-workflow)
    - [List Workflows](#list-workflows)
    - [Cancel Workflow](#cancel-workflow)
  - [Health Checks](#health-checks)
  - [Configuration](#configuration)
    - [Processing](#processing)
    - [Heartbeat \& Recovery](#heartbeat--recovery)
  ...
  - [Creating a New Host](#creating-a-new-host)
    ...
    - [2. Define Your Command](#2-define-your-command)
    - [3. Compose in Program.cs](#3-compose-in-programcs)
    - [4. Write Tests](#4-write-tests)
  - [The App Layer: `WorkflowEngine.App`](#the-app-layer-workflowengineapp)
    - [AppCommand](#appcommand)
    - [Error Classification](#error-classification)
    - [State Passing](#state-passing-1)
