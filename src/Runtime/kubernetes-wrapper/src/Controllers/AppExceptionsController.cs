...
using Altinn.Studio.KubernetesWrapper.Models.Dto;
...
public class AppExceptionsController(IAppExceptionsService appExceptionsService) : ControllerBase
{
    ...
    [HttpGet]
    [EnableCors]
    public async Task<ActionResult<IEnumerable<AppException>>> GetAll([FromQuery] LogFiltersDto logFiltersDto, CancellationToken cancellationToken = default)
    {
