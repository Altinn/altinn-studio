...
public record Party
{
    ...
    /// <summary>
    /// Gets or sets the <see cref="Register.Contracts.V1.PartyType"/>.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the <see cref="Register.Contracts.V1.Person"/>, if the party is a person.
    /// </summary>
    [JsonPropertyName("person")]
    public Person? Person { get; set; }

    /// <summary>
    /// Gets or sets the <see cref="Register.Contracts.V1.Organization"/>, if the party is an organisation.
    /// </summary>
