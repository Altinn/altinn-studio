...
using LocalInstanceEventRepository = LocalTest.Services.Storage.Implementation.InstanceEventRepository;
...
internal sealed class LocalStorageFixture : IAsyncDisposable
{
    ...
    public LocalStorageFixture()
    {
        ...
        InstanceEventRepository = new LocalInstanceEventRepository(options);
    ...
    public LocalInstanceEventRepository InstanceEventRepository { get; }
