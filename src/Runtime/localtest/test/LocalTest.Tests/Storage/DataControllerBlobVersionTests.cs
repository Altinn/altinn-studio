...
public sealed class DataControllerBlobVersionTests
{
    [Fact]
    public async Task Get_WithMatchingIfMatch_ReturnsContentAndETag()
    {
        ...
        fixture.Controller.Request.Headers[HeaderNames.IfMatch] = fixture.ETag;
        ...
        Assert.Equal(fixture.ETag, fixture.Controller.Response.Headers.ETag);
    ...
    public async Task Get_ContentVersionChangesAfterSnapshot_UsesCapturedVersionForConditionPathAndEtag()
    {
        ...
        string capturedETag = fixture.ETag;
        ...
        fixture.Controller.Request.Headers[HeaderNames.IfMatch] = capturedETag;
        ...
        Assert.IsType<FileStreamResult>(result);
        Assert.Equal(capturedETag, fixture.Controller.Response.Headers.ETag);
        Assert.Equal(
            nextBlobVersion,
    ...
    private sealed class ControllerFixture : IAsyncDisposable
    {
        ...
        public string ETag => BlobVersionId.ToETag(DataElement.BlobVersionId)!;
