...
describe('Time Format Utilities', () => {
  ...
  describe('isValidSegmentInput', () => {
    ...
    it('should handle partial input during typing', () => {
      ...
      expect(isValidSegmentInput('3', 'hours', 'HH:mm')).toBe(true);
      expect(isValidSegmentInput('9', 'hours', 'HH:mm')).toBe(true);
      expect(isValidSegmentInput('5', 'minutes', 'HH:mm')).toBe(true);
    });
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle hour conversion edge cases', () => {
      expect(formatSegmentValue(0, 'hours', 'hh:mm a')).toBe('12');
      expect(formatSegmentValue(12, 'hours', 'hh:mm a')).toBe('12');
      expect(formatSegmentValue(13, 'hours', 'hh:mm a')).toBe('01');
      expect(formatSegmentValue(23, 'hours', 'hh:mm a')).toBe('11');
    });
  });
});
