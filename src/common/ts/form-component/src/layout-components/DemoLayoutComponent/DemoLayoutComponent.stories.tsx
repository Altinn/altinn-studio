...
export const WithHtml: Story = {
  args: {
    content: `<h3>Dette er innhold satt med props some html, men kan være html eller markdown</h3>
...
export const WithMarkdown: Story = {
  args: {
    content: `### Dette er innhold satt med props some tekst, men kan være **html** eller **markdown**
