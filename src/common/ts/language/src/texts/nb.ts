import type { FixedLanguageList } from '@app/language/types';
...
export function nb() {
  return {
    ...
    'address_component.house_number_helper':
      'Om adressen er felles for flere boenheter må du oppgi bolignummer. Den består av en bokstav og fire tall og skal være ført opp ved/på inngangsdøren din.',
    ...
    'address_component.validation_error_zipcode':
      'Postnummer er ugyldig. Et postnummer består kun av 4 siffer.',
    ...
    'date_picker.min_date_exceeded': 'Datoen du har valgt er før tidligst tillatte dato.',
    'date_picker.max_date_exceeded': 'Datoen du har valgt er etter seneste tillatte dato.',
    ...
    'form_filler.error_add_subform':
      'Det oppstod en feil ved opprettelse av underskjema, vennligst prøv igjen',
    'form_filler.error_delete_subform':
      'Noe gikk galt ved sletting av underskjema, vennligst prøv igjen',
    'form_filler.error_fetch_subform': 'Feil ved lasting av skjemadata',
    'form_filler.error_max_count_reached_subform_server':
      'Maks antall {0} oppføringer har blitt nådd',
    'form_filler.error_max_count_reached_subform_local':
      'Maks antall {0} oppføringer har blitt nådd {1}',
    ...
    'form_filler.file_uploader_failed_to_upload_file':
      'Filen <u title="{1}">{0}</u> kunne ikke lastes opp',
    ...
    'form_filler.file_uploader_validation_error_file_number':
      'For å fortsette må du laste opp {0} vedlegg',
    ...
    'form_filler.ssn': 'fødselsnummer',
    'form_filler.fullName': 'navn',
    'form_filler.firstName': 'fornavn',
    'form_filler.middleName': 'mellomnavn',
    'form_filler.lastName': 'etternavn',
    'form_filler.orgnr': 'organisasjonsnummer',
    'form_filler.name': 'organisasjonsnavn',
    ...
    'image_upload_component.error_file_size_exceeded':
      'Filen er for stor. Største tillatte filstørrelse er 10MB.',
    ...
    'instantiate.forbidden_action_error_title':
      'Du mangler rettigheter til å utføre denne handlingen',
    ...
    'payment.receipt.address': 'Adresse',
    ...
    'organization_lookup.orgnr_label': 'Organisasjonsnummer',
    'organization_lookup.org_name': 'Organisasjonsnavn',
    'organization_lookup.from_registry_description': 'Fra enhetsregisteret',
    'organization_lookup.validation_error_not_found':
      'Organisasjonsnummeret ble ikke funnet i enhetsregisteret',
    'organization_lookup.validation_invalid_response_from_server': 'Ugyldig respons fra server',
    'organization_lookup.unknown_error': 'Ukjent feil. Vennligst prøv igjen senere',
    'organization_lookup.validation_error_orgnr': 'Organisasjonsnummeret er ugyldig',
    'organization_lookup.error_required': 'Du må fylle ut {0} og hente opplysninger',
    'organization_lookup.submit_button': 'Hent opplysninger',
    'organization_lookup.clear_button': 'Fjern',
    ...
    'config_error.subform_no_datatype_appmetadata':
      "Datatype '{0}' ble ikke funnet i applicationmetadata.json.",
    ...
    'config_error.lommebok_datatype_not_found':
      "Datatypen '{0}' (satt som saveToDataType for dokumentet '{1}') ble ikke funnet i applicationmetadata.json.",
    'config_error.lommebok_datatype_invalid_settings':
      "Datatypen '{0}' (satt som saveToDataType for dokumentet '{1}') har ugyldige innstillinger: {2}",
    'config_error.lommebok_upload_datatype_not_found':
      "Datatypen '{0}' (satt som alternativeUploadToDataType for dokumentet '{1}') ble ikke funnet i applicationmetadata.json.",
    'config_error.lommebok_upload_datatype_invalid_mimetype':
      "Datatypen '{0}' (satt som alternativeUploadToDataType for dokumentet '{1}') må tillate 'application/pdf' i allowedContentTypes.",
    'config_error.lommebok_issue_datatype_not_found':
      "Datatypen '{0}' (satt som urlDataType for dokumentet '{1}') ble ikke funnet i applicationmetadata.json.",
    'config_error.lommebok_issue_missing_url_field': "Dokumentet '{0}' mangler den påkrevde innstillingen urlField.",
    ...
    'config_error.deletion_strategy_no_group':
      'Feltene deletionStrategy og checked kan kun brukes sammen med group.',
    'config_error.group_no_deletion_strategy':
      'Når du har satt group må du også sette deletionStrategy.',
    'config_error.soft_delete_no_checked':
      'Når du har satt deletionStrategy til soft må du også sette "checked".',
    'config_error.hard_delete_with_checked':
      'Når du har satt deletionStrategy til hard kan du ikke sette "checked".',
    ...
    'signing.submit_panel_radio_group_description':
      'Følgende er parter du har rettigheter til å signere på vegne av.',
    ...
    'signing.error_signing_not_confirmed_documents':
      'Du må bekrefte at du har lest dokumentene før du signerer.',
    'signing.error_signing_no_on_behalf_of':
      'Du må velge hvem du signerer på vegne av før du signerer.',
    ...
    'signing_document_list.unknown_api_error': 'En feil oppstod under henting av dokumenter.',
    ...
    'wallet.request_document': 'Hent fra lommebok',
    'wallet.upload_document': 'Last opp dokument',
    'wallet.remove_data': 'Fjern data',
    'wallet.confirm_request_title': 'Hent dokument fra lommebok',
    'wallet.confirm_request_description': 'Du er i ferd med å be om følgende dokument fra lommeboken din:',
    'wallet.confirm_claims_description': 'Følgende opplysninger vil bli forespurt:',
    'wallet.confirm_proceed': 'Fortsett',
    'wallet.verification_failed': 'Verifiseringen mislyktes. Prøv igjen.',
    'wallet.data_received_title': 'Data mottatt',
    'wallet.data_received_description': 'Følgende opplysninger ble mottatt fra lommeboken din:',
    ...
    'wallet.verification_description':
      'Skann QR-koden med lommebok-appen din, eller bruk knappen under for å åpne den direkte.',
    'wallet.open_wallet': 'Åpne lommebok',
    'wallet.cancel_request': 'Avbryt',
    'wallet.issue_title': 'Legg til i lommebok',
    'wallet.issue_description':
      'Skann QR-koden med lommebok-appen din for å legge til {0}, eller bruk knappen under for å åpne den direkte.',
    'wallet.open_wallet_accept': 'Åpne lommebok',
    'wallet.issue_no_url': 'Ingen legitimasjon er tilgjengelig for utstedelse ennå.',
    'wallet.issue_to_wallet': 'Legg til i lommebok',
    'wallet.image_alt': 'Bilde fra lommebok',
    'wallet.yes': 'Ja',
    'wallet.no': 'Nei',
    'wallet.no_data_to_save': 'Ingen data å lagre. Sjekk feltkonfigurasjonen for dette dokumentet.',
    'wallet.upload_success': 'Dataene ble lagret.',
    'wallet.pdf_only': 'Bare PDF-filer kan lastes opp.',
    'wallet.pdf_upload_success': 'Filen ble lastet opp.',
    'wallet.pdf_upload_conflict': 'Det er allerede lastet opp en fil for dette dokumentet.',
    'wallet.pdf_upload_failed': 'Filen kunne ikke lastes opp. Prøv igjen.',
