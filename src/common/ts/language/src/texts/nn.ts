...
export function nn() {
  return {
    ...
    'address_component.title_text_binding': 'Søk etter leietekst for Adressekomponenten',
    ...
    'date_picker.min_date_exceeded': 'Dato vald er før tidlegaste dato tillat',
    'date_picker.max_date_exceeded': 'Dato vald er etter seinaste dato tillat',
    ...
    'timepicker.hours': 'Timar',
    'timepicker.minutes': 'Minutt',
    'timepicker.seconds': 'Sekund',
    ...
    'form_filler.subform_default_header': 'Oppføringar',
    'form_filler.alert_confirm': 'Bekreft',
    'form_filler.checkbox_alert': 'Er du sikker på at du vil fjerne avkryssinga?',
    ...
    'form_filler.file_uploader_validation_error_file_size': '{0} overskrid tillaten filstorleik.',
    ...
    'form_filler.fullName': 'namn',
    'form_filler.firstName': 'førenamn',
    'form_filler.middleName': 'mellomnamn',
    'form_filler.lastName': 'etternamn',
    'form_filler.orgnr': 'organisasjonsnummer',
    'form_filler.name': 'organisasjonsnamn',
    'navigation.main': 'Overordna',
    'navigation.form': 'Skjemasider',
    'navigation.to_main_content': 'Hopp til hovudinnhaldet',
    ...
    'general.add_connection': 'Legg til tilkopling',
    ...
    'iframe_component.unsupported_browser_title': 'Nettlesaren din er ikkje støtta',
    ...
    'image_upload_component.animated_warning':
      'Viss biletet er animert, blir berre det første biletet vist.',
    ...
    'image_upload_component.error_file_size_exceeded':
      'Fila er for stor. Største tillatne filstorleik er 10MB.',
    ...
    'instantiate.authorization_error_ask':
      'Om du representerer ein person, er det den du representerer som kan gi deg dei naudsynte rettane til å starte tenesta. Representerer du ein organisasjon er det personar som har rolla tilgangsstyring internt i organisasjonen som kan gi deg dei naudsynte rettane.',
    ...
    'party_selection.no_valid_selection_third_part':
      'For å starte denne tenesta må du ha tilgangar som knyter deg til ein {0}.',
    ...
    'party_selection.unit_type_bankruptcy_state': 'konkursbu',
    ...
    'payment.alert.failed': 'Betalinga feila',
    ...
    'payment.receipt.receiver': 'Mottakar',
    'payment.receipt.payer': 'Betaler',
    'payment.receipt.name': 'Namn',
    'payment.receipt.company_name': 'Firmanamn',
    ...
    'payment.component.description': 'Skildring',
    'payment.component.quantity': 'Tal',
    ...
    'organization_lookup.org_name': 'Organisasjonsnamn',
    'organization_lookup.from_registry_description': 'Frå enhetsregisteret',
    'organization_lookup.validation_error_not_found':
      'Organisasjonsnummeret er ikkje funne i registeret',
    'organization_lookup.validation_invalid_response_from_server': 'Ugyldig respons frå server',
    'organization_lookup.unknown_error': 'Ukjent feil. Ver venleg og prøv igjen seinare',
    'organization_lookup.validation_error_orgnr': 'Organisasjonsnummeret er ugyldig',
    'organization_lookup.error_required': 'Du må fylla ut {0} og henta opplysningar',
    'organization_lookup.submit_button': 'Hent opplysningar',
    ...
    'validation_errors.length': 'Talet på tillatne teikn er {0}',
    ...
    'validation_errors.minItems': 'Minst {0} radar er påkravd',
    ...
    'multiple_select_component.no_options': 'Ingen val tilgjengelege',
    'multiple_select_component.placeholder': 'Vel ...',
    ...
    'process_workflow.having_trouble':
      'Vi får ikkje handsama skjemaet ditt akkurat no, men vi prøver igjen automatisk. Opplysningane dine er lagra. Du kan trygt lukke sida og kome tilbake seinare. Du kan opne skjema du allereie har starta på, frå innboksen eller frå Utkast-mappa.',
    ...
    'taskTypes.confirmation': 'Stadfesting',
