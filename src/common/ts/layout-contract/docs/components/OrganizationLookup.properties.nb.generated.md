...
<details class="component-property-group" id="datamodelbindings">
  ...
  <div class="component-property-group-content">
    ...
    <div class="component-property-list">
      <details class="card adocs-expand adocs-expand-small component-property" id="datamodelbindings.orgnr">
        <summary class="component-property-summary">
          <span class="component-property-chevron" aria-hidden="true"></span>
          <span class="component-property-name" title="dataModelBindings.orgnr">dataModelBindings.orgnr</span>
          <span class="component-property-summary-meta">
            <span class="component-property-required is-required">Påkrevd</span>
        ...
        <div class="a-collapseContent-inside component-property-details"><div class="component-property-description">Angir hvor i datamodellen komponenten skal lagre organisasjonsnummeret til organisasjonen som slås opp. <a href="/nb/altinn-studio/v9/develop-a-service/reference/data/data-model-bindings/">Slik bruker du datamodellbindinger.</a></div></div>
      </details>

      <details class="card adocs-expand adocs-expand-small component-property" id="datamodelbindings.name">
        <summary class="component-property-summary">
          <span class="component-property-chevron" aria-hidden="true"></span>
          <span class="component-property-name" title="dataModelBindings.name">dataModelBindings.name</span>
          <span class="component-property-summary-meta">
            <span class="component-property-required">Valgfri</span>
            <span class="component-property-type" title="datamodellbinding">Type: <span class="component-property-value"><a href="/nb/altinn-studio/v9/develop-a-service/reference/data/data-model-bindings/">datamodellbinding</a></span></span>
          </span>
        </summary>
        <div class="a-collapseContent-inside component-property-details"><div class="component-property-description">Angir hvor i datamodellen komponenten skal lagre organisasjonsnavnet. <a href="/nb/altinn-studio/v9/develop-a-service/reference/data/data-model-bindings/">Slik bruker du datamodellbindinger.</a></div></div>
      </details>
    </div>
