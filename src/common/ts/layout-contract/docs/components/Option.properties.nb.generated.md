...
| `type` | `"Option"` | Ja |  | Angir hvilken komponenttype konfigurasjonen gjelder. |
...
| `value` | `string \| expression<string>` | Ja |  | Verdien alternativet representerer. |
| `direction` | `"horizontal" \| "vertical"` | Nei | `"horizontal"` | Tillatte verdier: "horizontal", "vertical". |
| `icon` | `string` | Nei |  | URL-en til et ikon som vises med alternativet. |
