...
| `type`                                        | `"AccordionGroup"`               | Yes      |         | Identifies which component type this configuration represents.                                              |
...
| `textResourceBindings.title`                  | `string \| expression<string>`   | No       |         | The title of the accordion group                                                                            |
| `children`                                    | `string[]`                       | Yes      |         | List of child component IDs to show inside the accordion group (limited to other Accordion components)      |
