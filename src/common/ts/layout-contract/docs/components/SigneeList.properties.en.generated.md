...
| ----------------------------------- | ------------------------------ | -------- | ------- | -------------------------------------------------------------- |
| `type`                              | `"SigneeList"`                 | Yes      |         | Identifies which component type this configuration represents. |
...
| `textResourceBindings.summaryTitle` | `string \| expression<string>` | No       |         | Title of the summary                                           |
