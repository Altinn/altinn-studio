...
| `labelSettings.optionalIndicator`  | `boolean`                      | No       | `true`  | Show the optional indicator on the label of non-required fields. Enabled by default, as recommended by Designsystemet. |
