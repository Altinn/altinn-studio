...
| `type`                                        | `"Paragraph"`                    | Yes      |         | Identifies which component type this configuration represents.                                              |
...
| `textResourceBindings.help`                   | `string \| expression<string>`   | No       |         | Help text, optionally shown in a tooltip                                                                    |
