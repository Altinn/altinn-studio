...
| `type` | `"AddToList"` | Yes |  | Identifies which component type this configuration represents. |
...
| `dataModelBindings.data` | `object` | Yes |  | Dot notation location for a repeating group structure (array of objects), where the data is stored |
| `dataModelBindings.data.dataType` | `string` | Yes |  | The name of the datamodel type to reference |
| `dataModelBindings.data.field` | `string` | Yes |  | The path to the property using dot-notation |
