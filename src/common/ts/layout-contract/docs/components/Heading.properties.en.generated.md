...
| `type` | `"Heading"` | Yes |  | Identifies which component type this configuration represents. |
...
| `textResourceBindings.title` | `string \| expression<string>` | No |  | The text to display in the heading |
| `textResourceBindings.help` | `string \| expression<string>` | No |  | The text to display in the help tooltip/popup |
| `size` | `"L" \| "M" \| "S" \| "h2" \| "h3" \| "h4"` | Yes |  | The size of the heading Allowed values: "L", "M", "S", "h2", "h3", "h4". |
