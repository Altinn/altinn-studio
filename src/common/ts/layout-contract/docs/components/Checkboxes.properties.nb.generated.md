...
<details class="card adocs-expand adocs-expand-small component-property" id="preselectedoptionindex">
  ...
  <div class="a-collapseContent-inside component-property-details"><div class="component-property-description">Indeksen til alternativet som skal være forhåndsvalgt når brukeren ikke har valgt noe.</div></div>
</details>
  ...
  <div class="component-property-group-content">
    ...
    <div class="component-property-list">
      <details class="card adocs-expand adocs-expand-small component-property" id="datamodelbindings.simplebinding">
        ...
        <div class="a-collapseContent-inside component-property-details"><div class="component-property-description">Angir hvor i datamodellen komponenten skal lagre verdiene. <a href="/nb/altinn-studio/v9/develop-a-service/reference/data/data-model-bindings/">Slik bruker du datamodellbindinger.</a></div></div>
      </details>
      ...
      <details class="card adocs-expand adocs-expand-small component-property" id="datamodelbindings.label">
        ...
        <div class="a-collapseContent-inside component-property-details"><div class="component-property-description">Angir hvor i datamodellen komponenten skal lagre ledetekstene. <a href="/nb/altinn-studio/v9/develop-a-service/reference/data/data-model-bindings/">Slik bruker du datamodellbindinger.</a></div></div>
      </details>
      ...
      <details class="card adocs-expand adocs-expand-small component-property" id="datamodelbindings.metadata">
        ...
        <div class="a-collapseContent-inside component-property-details"><div class="component-property-description">Angir hvor i datamodellen komponenten skal lagre metadata. <a href="/nb/altinn-studio/v9/develop-a-service/reference/data/data-model-bindings/">Slik bruker du datamodellbindinger.</a></div></div>
      </details>
      ...
      <details class="card adocs-expand adocs-expand-small component-property" id="datamodelbindings.group">
        ...
        <div class="a-collapseContent-inside component-property-details"><div class="component-property-description">Plassering i punktnotasjon for den repeterende strukturen der verdiene fra avkryssede bokser skal lagres. <a href="/nb/altinn-studio/v9/develop-a-service/reference/data/data-model-bindings/">Slik bruker du datamodellbindinger.</a></div></div>
      </details>
      ...
      <details class="card adocs-expand adocs-expand-small component-property" id="datamodelbindings.checked">
        ...
        <div class="a-collapseContent-inside component-property-details"><div class="component-property-description">Hvis deletionStrategy er soft og group er satt, peker verdien til feltet der slettestatusen skal lagres. <a href="/nb/altinn-studio/v9/develop-a-service/reference/data/data-model-bindings/">Slik bruker du datamodellbindinger.</a></div></div>
      </details>
    </div>
...
<details class="card adocs-expand adocs-expand-small component-property" id="deletionstrategy">
  ...
  <div class="a-collapseContent-inside component-property-details"><div class="component-property-description">Tillatte verdier: "soft", "hard".</div></div>
</details>
...
<details class="card adocs-expand adocs-expand-small component-property" id="layout">
  ...
  <div class="a-collapseContent-inside component-property-details"><div class="component-property-description">Angir hvordan alternativene skal plasseres. Tillatte verdier: "column", "row", "table".</div></div>
</details>
...
<details class="card adocs-expand adocs-expand-small component-property" id="showlabelsintable">
  ...
  <div class="a-collapseContent-inside component-property-details"><div class="component-property-description">Angir om ledeteksten skal vises når tabellen bare har ett alternativ.</div></div>
</details>
...
<details class="card adocs-expand adocs-expand-small component-property" id="alertonchange">
  ...
  <div class="a-collapseContent-inside component-property-details"><div class="component-property-description">Angir om komponenten skal varsle ved endringer.</div></div>
</details>
