...
| `type` | `"Checkboxes"` | Ja |  | Angir hvilken komponenttype konfigurasjonen gjelder. |
...
| `layout` | `"column" \| "row" \| "table"` | Nei |  | Angir hvordan alternativene skal plasseres. Tillatte verdier: "column", "row", "table". |
| `showLabelsInTable` | `boolean` | Nei | `false` | Angir om ledeteksten skal vises når tabellen bare har ett alternativ. |
