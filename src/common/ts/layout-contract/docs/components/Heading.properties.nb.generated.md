...
| `type` | `"Heading"` | Ja |  | Angir hvilken komponenttype konfigurasjonen gjelder. |
...
| `textResourceBindings.title` | `string \| expression<string>` | Nei |  | Teksten som vises i overskriften. |
| `textResourceBindings.help` | `string \| expression<string>` | Nei |  | Teksten som vises i hjelpetekstvinduet. |
| `size` | `"L" \| "M" \| "S" \| "h2" \| "h3" \| "h4"` | Ja |  | Overskriftens størrelse. Tillatte verdier: "L", "M", "S", "h2", "h3", "h4". |
