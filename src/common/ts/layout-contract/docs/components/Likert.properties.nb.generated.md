...
<details class="card adocs-expand adocs-expand-small component-property" id="columns">
  ...
  <div class="a-collapseContent-inside component-property-details"><div class="component-property-description">Tilpasser kolonnene i Likert-komponenten.</div></div>
</details>
...
<details class="card adocs-expand adocs-expand-small component-property" id="columns[].value">
  ...
  <div class="a-collapseContent-inside component-property-details"><div class="component-property-description">Verdien i svarkolonnen.</div></div>
</details>
...
<details class="card adocs-expand adocs-expand-small component-property" id="columns[].divider">
  ...
  <div class="a-collapseContent-inside component-property-details"><div class="component-property-description">Angir om skillelinjen skal vises før, etter eller på begge sider av kolonnen. Tillatte verdier: "before", "after", "both".</div></div>
</details>
  ...
  <div class="component-property-group-content">
    ...
    <div class="component-property-list">
      ...
      <details class="card adocs-expand adocs-expand-small component-property" id="textresourcebindings.title">
        ...
        <div class="a-collapseContent-inside component-property-details"><div class="component-property-description">Ledeteksten til gruppen.</div></div>
      </details>
      ...
      <details class="card adocs-expand adocs-expand-small component-property" id="textresourcebindings.description">
        ...
        <div class="a-collapseContent-inside component-property-details"><div class="component-property-description">Beskrivelsen av Likert-tabellen.</div></div>
      </details>
      ...
      <details class="card adocs-expand adocs-expand-small component-property" id="textresourcebindings.leftcolumnheader">
        ...
        <div class="a-collapseContent-inside component-property-details"><div class="component-property-description">Overskriften for venstre kolonne i Likert-tabellen.</div></div>
      </details>
      ...
      <details class="card adocs-expand adocs-expand-small component-property" id="textresourcebindings.questions">
        ...
        <div class="a-collapseContent-inside component-property-details"><div class="component-property-description">Spørsmålene som vises i hver rad. Bruk en dynamisk tekstressurs.</div></div>
      </details>
      ...
      <details class="card adocs-expand adocs-expand-small component-property" id="textresourcebindings.questiondescriptions">
        ...
        <div class="a-collapseContent-inside component-property-details"><div class="component-property-description">Beskrivelsene som vises i hver rad. Bruk en dynamisk tekstressurs.</div></div>
      </details>
      ...
      <details class="card adocs-expand adocs-expand-small component-property" id="textresourcebindings.questionhelptexts">
        ...
        <div class="a-collapseContent-inside component-property-details"><div class="component-property-description">Hjelpetekstene som vises i hver rad. Bruk en dynamisk tekstressurs.</div></div>
      </details>
    </div>
  ...
  <div class="component-property-group-content">
    ...
    <div class="component-property-list">
      <details class="card adocs-expand adocs-expand-small component-property" id="datamodelbindings.answer">
        ...
        <div class="a-collapseContent-inside component-property-details"><div class="component-property-description">Plassering i punktnotasjon for svarene. Må peke på en egenskap i objektene i spørsmålslisten. <a href="/nb/altinn-studio/v9/develop-a-service/reference/data/data-model-bindings/">Slik bruker du datamodellbindinger.</a></div></div>
      </details>
      ...
      <details class="card adocs-expand adocs-expand-small component-property" id="datamodelbindings.questions">
        ...
        <div class="a-collapseContent-inside component-property-details"><div class="component-property-description">Plassering i punktnotasjon for Likert-strukturen, en liste med objekter, der dataene lagres. <a href="/nb/altinn-studio/v9/develop-a-service/reference/data/data-model-bindings/">Slik bruker du datamodellbindinger.</a></div></div>
      </details>
    </div>
...
<details class="card adocs-expand adocs-expand-small component-property" id="filter">
  ...
  <div class="a-collapseContent-inside component-property-details"><div class="component-property-description">Filtrerer radene i Likert-gruppen med start- og stoppindekser. Startindeksen teller fra null, og stoppindeksen teller fra én. For eksempel viser {start, stop} = {0, 3} tre rader, ikke fire.</div></div>
</details>
...
<details class="card adocs-expand adocs-expand-small component-property" id="filter[].key">
  ...
  <div class="a-collapseContent-inside component-property-details"><div class="component-property-description">Tillatte verdier: "start", "stop".</div></div>
</details>
