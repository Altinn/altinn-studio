...
| `type` | `"RadioButtons"` | Yes |  | Identifies which component type this configuration represents. |
...
| `showAsCard` | `boolean` | No |  | Boolean value indicating if the options should be displayed as cards. Defaults to false. |
