...
| `type` | `"Datepicker"` | Ja |  | Angir hvilken komponenttype konfigurasjonen gjelder. |
...
| `autocomplete` | `"bday"` | Nei |  |  |
| `minDate` | `string \| expression<string> \| "today" \| "yesterday" \| "tomorrow" \| "oneYearAgo" \| "oneYearFromNow"` | Nei | `"1900-01-01T12:00:00.000Z"` | Angir tidligste tillatte dato. Nøkkelordet «today» sperrer dynamisk alle tidligere datoer. |
| `maxDate` | `string \| expression<string> \| "today" \| "yesterday" \| "tomorrow" \| "oneYearAgo" \| "oneYearFromNow"` | Nei | `"2100-01-01T12:00:00.000Z"` | Angir seneste tillatte dato. Nøkkelordet «today» sperrer dynamisk alle fremtidige datoer. |
| `timeStamp` | `boolean` | Nei | `false` | Angir om dato og klokkeslett skal lagres som et tidsstempel. |
| `format` | `string` | Nei | `"dd.MM.yyyy"` | Datoformatet som brukes ved utfylling og visning. |
