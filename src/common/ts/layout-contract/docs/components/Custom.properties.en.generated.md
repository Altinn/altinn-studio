  ...
  <div class="component-property-group-content">
    ...
    <div class="component-property-list">
      ...
      <details class="card adocs-expand adocs-expand-small component-property" id="textresourcebindings.title">
        ...
        <div class="a-collapseContent-inside component-property-details"><div class="component-property-description">Title (passed on as the "text" property to the component)</div></div>
      </details>
    </div>
...
<details class="card adocs-expand adocs-expand-small component-property" id="tagname">
  ...
  <div class="a-collapseContent-inside component-property-details"><div class="component-property-description">Web component tag name to use</div></div>
</details>
