...
| `type` | `"ImageUpload"` | Yes |  | Identifies which component type this configuration represents. |
...
| `crop` | `object \| object` | No | `{"shape":"circle","diameter":250}` | Configures the shape and size of the image cropping area. |
| `crop.shape` | `"circle"` | Yes |  | Circular cropping area |
| `crop.diameter` | `number` | No | `250` | Diameter of the circle |
| `crop.shape` | `"rectangle"` | Yes |  | Rectangular cropping area |
| `crop.width` | `number` | No | `250` | Width of the rectangle |
| `crop.height` | `number` | No | `250` | Height of the rectangle |
