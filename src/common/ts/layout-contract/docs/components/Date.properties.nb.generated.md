...
| `type` | `"Date"` | Ja |  | Angir hvilken komponenttype konfigurasjonen gjelder. |
...
| `format` | `string` | Nei |  | Formatet som brukes for å vise datoen. |
| `value` | `string \| expression<string>` | Ja |  | Datoverdien som skal vises. |
| `direction` | `"horizontal" \| "vertical"` | Nei | `"horizontal"` | Tillatte verdier: "horizontal", "vertical". |
| `icon` | `string` | Nei |  | URL-en til et ikon som vises sammen med datoen. |
