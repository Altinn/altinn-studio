...
| ----------------------------------- | ------------------------------ | ------- | ------------- | --------------------------------------------------------------- |
| `type`                              | `"SigningDocumentList"`        | Ja      |               | Angir hvilken komponenttype konfigurasjonen gjelder.            |
...
| `textResourceBindings.summaryTitle` | `string \| expression<string>` | Nei     |               | Overskriften eller ledeteksten til oppsummeringen.              |
