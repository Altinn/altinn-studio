...
| `type` | `"Paragraph"` | Ja |  | Angir hvilken komponenttype konfigurasjonen gjelder. |
...
| `textResourceBindings.help` | `string \| expression<string>` | Nei |  | Valgfri hjelpetekst som vises i et hjelpetekstvindu. |
