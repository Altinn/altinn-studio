...
| [`typescript`](typescript/AGENTS.md) | React and TypeScript libraries shared by App Frontend, Designer, and other consumers. | Follow the TypeScript-specific instructions. |
