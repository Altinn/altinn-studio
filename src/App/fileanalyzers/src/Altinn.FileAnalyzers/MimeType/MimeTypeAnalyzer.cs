...
{
    /// <inheritDoc/>
    // Deliberately keeps the British spelling: apps reference this id verbatim in
    // the enabledFileAnalysers list in applicationmetadata, so renaming it would
    // silently stop the analyzer from running. Changing it needs an app migration.
