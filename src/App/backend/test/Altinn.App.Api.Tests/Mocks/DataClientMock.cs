...
internal sealed class DataClientMock : IDataClient, IDataClientWithStorageMetadata, IInstanceMutationClient
{
    ...
    )
    {
        ...
        {
            throw new PlatformHttpException(HttpStatusCode.PreconditionFailed, "Blob version mismatch");
        }
        return bytes;
    }
