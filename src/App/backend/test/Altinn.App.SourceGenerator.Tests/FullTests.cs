    ...
    public async Task Run()
    {
        var source = """
            ...
            public class OldXmlValue
            {
              ...
              // Fixed values as generated by Altinn Studio for XSD attributes with a fixed value
              [XmlAttribute("dataFormatVersion")]
              [BindNever]
              public string dataFormatVersion { get; set; } = "46317";

              [XmlAttribute("fixedInt")]
              [BindNever]
              public int fixedInt { get; set; } = -42;

              [XmlAttribute("fixedDecimal")]
              [BindNever]
              public decimal? fixedDecimal { get; set; } = 1.5m;

              // Not fixed: no initializer, initializer is not a literal, or no [BindNever]
              [XmlAttribute("notFixedNoInitializer")]
              [BindNever]
              public string? notFixedNoInitializer { get; set; }

              [XmlAttribute("notFixedExpression")]
              [BindNever]
              public string notFixedExpression { get; set; } = string.Empty;

              [XmlAttribute("notFixedNoBindNever")]
              [JsonPropertyName("notFixedNoBindNever")]
              public string? notFixedNoBindNever { get; set; } = "x";
            }
            """;
        var syntax = CSharpSyntaxTree.ParseText(source, path: "models/Models.cs");
