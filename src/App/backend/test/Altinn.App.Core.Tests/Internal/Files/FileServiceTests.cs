...
{
    [Fact]
    public async Task RunFileAnalysisAndValidation_NoAnalyzersOrValidators_ReturnsNull()
    {
        // Arrange
    ...
    [Fact]
    public async Task RunFileAnalysisAndValidation_WithAnalyzersOnly_ValidationSucceeds_ReturnsNull()
    {
        // Arrange
        var fileAnalysisService = new Mock<IFileAnalysisService>();
        var fileValidationService = new Mock<IFileValidationService>();
    ...
    [Fact]
    public async Task RunFileAnalysisAndValidation_WithAnalyzersAndValidators_ValidationSucceeds_ReturnsNull()
    {
        // Arrange
        var fileAnalysisService = new Mock<IFileAnalysisService>();
        var fileValidationService = new Mock<IFileValidationService>();
