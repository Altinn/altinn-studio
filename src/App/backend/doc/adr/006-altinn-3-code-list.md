...
- **A2: Modify existing path with nullable path variables**
  _GET /{org}/{app}/api/options/{optionIdOrCreatorOrg}/
  {codeListId?}/{version?}&language={language}_
...
- **A3: Modify existing path with new query parameters**
  _GET /{org}/{app}/api/options/{optionsIdOrCodeListId}?creatorOrg={org}&version={version}&language={language}_
