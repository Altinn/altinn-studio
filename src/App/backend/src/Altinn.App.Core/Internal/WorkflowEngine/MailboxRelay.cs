...
internal sealed class MailboxRelay
{
    ...
    /// mid-flight rename would otherwise point the successor at another exchange and make
    ...
    /// it. <paramref name="openingStageName"/> carries a third meaning here beyond the ones
