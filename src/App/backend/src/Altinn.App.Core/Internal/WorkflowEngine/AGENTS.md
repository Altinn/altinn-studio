...
└── Models/              - WorkflowCallbackState + SignedWorkflowState at the root;
                           ...
                           mailbox mint/read/close, RetryStrategy, PersistentItemStatus,
                           WorkflowRef, …)
```
