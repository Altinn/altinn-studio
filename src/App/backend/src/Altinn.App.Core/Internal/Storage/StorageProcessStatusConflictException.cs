...
internal sealed class StorageProcessStatusConflictException : PlatformHttpException
{
    ...
    private StorageProcessStatusConflictException(HttpResponseMessage response, string message)
    ...
    )
    {
        ...
        return new StorageProcessStatusConflictException(response, message);
    }
}
