...
/// <see cref="Deadline"/> is when the mailbox stops accepting answers. A retried or deferred attempt of the
/// stage is handed this same mailbox — the mint has already completed.
/// </summary>
