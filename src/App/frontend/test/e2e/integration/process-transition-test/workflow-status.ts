 ...
 *
 * UI states:
 *   processing  = the standard form loader, followed by a safe-to-leave message after five seconds
...
describe('Live workflow status (real engine)', () => {
  ...
  it('deferral with a custom layout: the app page renders during the wait, exactly as it does for park', () => {
    ...
    // default view would show the standard loader. (Reload-during-wait is covered by the
