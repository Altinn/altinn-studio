...
import { useLayouts } from 'nextsrc/nexttanstack/http-client/api-client/queries/layouts';
import { RenderLayout } from 'nextsrc/nexttanstack/render-logic/RenderLayout';
