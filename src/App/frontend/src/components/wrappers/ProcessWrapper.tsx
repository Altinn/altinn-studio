...
//   }
//
//   // While the router is transitioning to a new URL, the cache may have already flipped to the
//   // new task (writers update cache before/with navigate). Suppress the wrong-task verdict until
//   // navigation idles — at that point cache and URL are aligned and any remaining mismatch is a
//   // genuine wrong-URL state.
//   if ((isWrongTask || !isValidTaskId) && isNavigating) {
//     return <Loader reason='process-wrapper-navigating' />;
//   }
//
//   if (!isValidTaskId) {
//     return (
