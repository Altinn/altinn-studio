...
export abstract class DiktafonDef extends FormComponent<'Diktafon'> implements DisplayData {
  protected readonly type = 'Diktafon';

  // Do not override this one, set functionality.customExpressions to true instead
  evalDefaultExpressions(props: ExprResolver<'Diktafon'>) {
    return {
      ...(props.item as Omit<
        typeof props.item,
  ...
  // Do not override this one, set functionality.customExpressions to true instead
  evalExpressions(props: ExprResolver<'Diktafon'>) {
...
// Source hash: 66639dfc370dfd1391e1ea01b40af1c89d64ac8231b534876001838878f5f244
