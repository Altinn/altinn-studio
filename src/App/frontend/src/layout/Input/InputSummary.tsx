...
export const InputSummary = ({ targetBaseComponentId }: Summary2Props) => {
  ...
  const config = useComponentConfig(targetBaseComponentId, 'Input');
  const summaryTitle = useEvalExpression(
    config.textResourceBindings?.summaryTitle,
    Expressions.Input.textResourceBindings.summaryTitle,
  );
  const resolvedTitle = useEvalExpression(
    config.textResourceBindings?.title,
    Expressions.Input.textResourceBindings.title,
  );
