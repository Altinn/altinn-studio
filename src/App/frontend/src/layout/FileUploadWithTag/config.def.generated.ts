...
export abstract class FileUploadWithTagDef extends FormComponent<'FileUploadWithTag'> implements DisplayData {
  protected readonly type = 'FileUploadWithTag';

  // Do not override this one, set functionality.customExpressions to true instead
  evalDefaultExpressions(props: ExprResolver<'FileUploadWithTag'>) {
    return {
      ...(props.item as Omit<
        typeof props.item,
...
// Source hash: 7178349dfa8d481162b048de993940890185a73cb48d59fbf996d1e380cdf0f0
