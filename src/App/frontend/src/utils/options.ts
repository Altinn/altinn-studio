...
// TODO: Remove when both dropdown and multiple select are migrated to src/common/ts/form-component, since this method has been ported there when moving dropdown.
