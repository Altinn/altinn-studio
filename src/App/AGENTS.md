...
| `frontend`        | **Altinn 3 app frontend** — React/TS SPA that renders dynamic forms/layouts and talks to the app backend. Ships with every app.                                                      | React/TypeScript (Vite, Jest, Cypress)    | [frontend/AGENTS.md](frontend/AGENTS.md)           |
