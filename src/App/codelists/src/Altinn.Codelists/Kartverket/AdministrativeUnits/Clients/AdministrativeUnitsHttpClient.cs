...
internal sealed class AdministrativeUnitsHttpClient : IAdministrativeUnitsClient
{
    ...
    /// <summary>
    /// Sends an asynchronous GET request to get all the counties of Norway.
    /// </summary>
    ...
    /// <summary>
    /// Sends an asynchronous GET request to get all the municipalities of Norway.
    /// </summary>
    ...
    /// <summary>
    /// Sends an asynchronous GET request to get all the municipalities within the specified county.
    /// </summary>
