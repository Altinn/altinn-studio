...
- Warn in `studioctl app upgrade v9` about the obsolete `EformidlingStatusCheckEventHandler`, pointing at `AddEFormidlingServices2<TM, TR>`, which registers the status check for you.
