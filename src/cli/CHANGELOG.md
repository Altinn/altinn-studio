...
- `studioctl env up` on an environment that is already running now says when a newer build is available, and which images it affects, so you know a restart would pick something up.
