...
- Updating removes the image override file from your studioctl directory. It is no longer read, and `STUDIOCTL_IMAGE_LOCALTEST`, `STUDIOCTL_IMAGE_PDF3` and `STUDIOCTL_IMAGE_WORKFLOW_ENGINE` run a specific build for one session instead.
