...
export class AltinnInformationCard extends React.Component<IAltinnInformationCardComponentProvidedProps> {
  public render() {
        ...
        >
          <Grid
            className={classNames(classes.paper, {
              [classes.shadowBox]: this.props.shadow,
            })}
            container={true}
            item={true}
          >
              ...
              <Grid sm={12} md={7} item={true} container={true}>
                <Grid item={true}>
                  <h1 className={classes.header}>
                    {getLanguageFromKey(
                      this.props.headerTextKey,
                      this.props.language,
                    )}
                  </h1>
                  <p className={classes.subText1}>
                    {getLanguageFromKey(
                      this.props.subtext1TextKey,
                      this.props.language,
                    )}
                  </p>
                  <p className={classes.subText2}>
                    {getLanguageFromKey(
                      this.props.subtext2TextKey,
                      this.props.language,
                    )}
                  </p>
                  <div className={classes.smSpacing}>
                    <a
                      href={getLanguageFromKey(
                        this.props.urlKey,
                        this.props.language,
                      )}
