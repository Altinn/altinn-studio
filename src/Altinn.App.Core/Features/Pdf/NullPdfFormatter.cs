...
namespace Altinn.App.Core.Features.Pdf
{
    ...
    /// </summary>
    [Obsolete("This class was used for the old PDF generator, and is used for backwards compatibility in the new one. Create a custom pdf layout instead if you need to customize the PDF layout.")]
