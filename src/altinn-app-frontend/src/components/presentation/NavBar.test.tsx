  ...
  renderWithProviders(
    ...
    />, {
      preloadedState: {
        ...
        textResources: { resources: textResources, language: 'nb', error: null },
...
describe('components/presentation/NavBar.tsx', () => {
  ...
  it('should render back button', async () => {
    const { mockBack } = renderNavBar({ hideCloseButton: true, showBackArrow: true, showLanguageSelector: false });
