...
import {
  ...
  SelectFormData,
  SelectLayouts, SelectAttachments, SelectCurrentView
} from "src/features/form/data/update/updateFormDataSagas";
import { PayloadAction } from "@reduxjs/toolkit";
import { IDeleteAttachmentReference } from "src/features/form/data/formDataTypes";
...
describe('updateFormDataSagas', () => {
  const testDeleteAttachmentReferenceSaga = (formDataBefore: any, formDataAfter: any, attachmentState:IAttachments, componentId: string, dataBinding: IDataModelBindings) => (() => {
    ...
    return expectSaga(deleteAttachmentReferenceSaga, action)
      ...
      .put(FormDataActions.setFormDataFulfilled({ formData: expectedUpdatedFormData }))
  ...
  it('deleteAttachmentReferenceSaga works for simple components', testDeleteAttachmentReferenceSaga(
    {'MyAttachment': 'abc123'},
    {},
  ...
  it('deleteAttachmentReferenceSaga works for list binding', testDeleteAttachmentReferenceSaga(
  ...
  it('deleteAttachmentReferenceSaga works for list binding in repeating group', testDeleteAttachmentReferenceSaga(
    {'Group[0].MyAttachment[0]': 'abc123', 'Group[0].MyAttachment[1]': 'def456'},
