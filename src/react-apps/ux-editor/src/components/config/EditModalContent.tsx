...
class EditModalContentComponent extends React.Component<IEditModalContentProps, IEditModalContentState> {
  ...
  public handleAddOption = () => {
    ...
    updatedComponent.options.push({
      label: this.props.language ? this.props.language.general.label : 'Label',
      value: this.props.language ? this.props.language.general.value : 'Value',
    });
    this.setState({
          ...
          <div className='form-group a-form-group mt-2'>
            <div className='custom-control custom-control-stacked pl-0 custom-checkbox a-custom-checkbox'>
              ...
              <label className='pl-3 custom-control-label a-fontBold' htmlFor='InputIsDisabled'>
                {this.props.language ? this.props.language.general.disabled : 'Disabled'}
              </label>
            </div>
            <div className='custom-control custom-control-stacked pl-0 custom-checkbox a-custom-checkbox'>
              <input
              ...
              <label className='pl-3 custom-control-label a-fontBold' htmlFor='InputIsRequired'>
                {this.props.language ? this.props.language.general.required : 'Required'}
              </label>
            </div>
          </div>
        );
            ...
            <div className='row align-items-center'>
              <div className='col-5'>
                <label className='a-form-label'>
                  {this.props.language ? this.props.language.general.label : 'Label'}
                </label>
              </div>
              <div className='col-5'>
                <label className='a-form-label'>
                  {this.props.language ? this.props.language.general.value : 'Value'}
                </label>
              </div>
            </div>
                ...
                <div className='col-5'>
                  ...
                  >}
                    <option key={'empty'} value={''}>
                      {this.props.language ? this.props.language.general.choose_label : 'Choose label'}
                    </option>
