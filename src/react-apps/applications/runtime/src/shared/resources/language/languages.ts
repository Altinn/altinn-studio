...
export const nb = () => (
  {
    ...
    dashboard: {
      ...
      service_name_has_illegal_characters: 'Lagringsnavnet er ugyldig. Lagringsnavnet kan kun inneholde alfanumeriske tegn og bindestrek (\'-\'), det må begynne på en bokstav og ende med bokstav eller tall.',
      ...
      service_saved_name_description: 'Dette navnet brukes kun for å opprette tjenesten teknisk i løsningen. Navnet må begynne på en bokstav, ende på en bokstav eller tall og kan kun inneholde alfanumeriske tegn og bindestrek. Dette navnet kan ikke endres senere.',
    ...
    deploy_to_test: {
      ...
      check_csharp_compiles_true_title: 'Tjenestens C',
