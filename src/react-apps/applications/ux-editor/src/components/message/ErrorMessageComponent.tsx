...
const ErrorMessageContainer: React.StatelessComponent<IErrorMessageContainerProps> = (props: IErrorMessageContainerProps) => (
...
const mapStateToProps: (state: IAppState, props: any) => IErrorMessageContainerProps = (state: IAppState, props: any): IErrorMessageContainerProps => ({
