...
export type AnchorElHorizontal = 'left' | 'center' | 'right';
export type AnchorElVertical = 'top' | 'center' | 'bottom';
...
const defaultAnchorElement: PopoverOrigin = {
  horizontal: 'left',
  vertical: 'top',
};
...
const AltinnPopoverComponent = (props: React.PropsWithChildren<IAltinnPopoverProps>) => {
  const {
    anchorOrigin = defaultAnchorElement,
