...
export const returnCurrentTaskDataTypeId = (appMetaData: IApplication, instance: IInstance) => {
...
export const returnCurrentTaskData = (appMetaData: IApplication, instance: IInstance) => {
  const defaultDatatype = appMetaData.dataTypes.find((element) => element.appLogic !== null);
