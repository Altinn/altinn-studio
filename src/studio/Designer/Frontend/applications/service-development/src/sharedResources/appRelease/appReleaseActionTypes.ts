const moduleName: string = 'APP_RELEASES';

export const GET_APP_RELEASES: string = `${moduleName}.GET_APP_RELEASES`;
export const GET_APP_RELEASES_FULFILLED: string = `${moduleName}.GET_APP_RELEASES_FULFILLED`;
export const GET_APP_RELEASES_REJECTED: string = `${moduleName}.GET_APP_RELEASES_REJECTED`;
