...
export const getAddApplicationMetadataUrl = (): string =>
  `${basePath}/UIEditor/AddMetadataForAttachment`;
...
export const getDeleteApplicationMetadataUrl = (): string =>
  `${basePath}/UIEditor/DeleteMetadataForAttachment?id=`;
export const getDeleteForLayoutUrl = (layout: string): string =>
  `${basePath}/UIEditor/DeleteFormLayout/${layout}`;
...
export const getFetchRuleConfigurationUrl = () =>
  `${basePath}/UIEditor/GetJsonFile?fileName=RuleConfiguration.json`;
...
export const getSaveFormLayoutUrl = (layoutName: string): string =>
  `${basePath}/UIEditor/SaveFormLayout/${layoutName}`;
export const getSaveLayoutSettingsUrl = (): string => `${basePath}/UIEditor/SaveLayoutSettings`;
export const getSveSerConfUrl = (): string =>
  `${basePath}/UIEditor/SaveJsonFile?fileName=RuleConfiguration.json`;
export const getUpLayNmeUrl = (layoutName: string) =>
  `${basePath}/UIEditor/UpdateFormLayoutName/${layoutName}`;
