...
const config = {
  ...
  moduleNameMapper: {
    // prettier-ignore
    '\\.(jpg|jpeg|png|gif|eot|otf|webp|ttf|woff|woff2|mp4|webm|wav|mp3|m4a|aac|oga)$': path.join(__dirname, 'testing/mocks/fileMock.js'),
    '\\.(css|less)$': path.join(__dirname, 'testing/mocks/styleMock.js'),
    '\\.(svg)$': path.join(__dirname, 'testing/mocks/svgMock.ts'),
