...
export const actions = {
  ...
  addApplicationMetadataFulfilled: createAction(
    `${moduleName}/addApplicationMetadataFulfilled`,
  ),
  addFormComponent: createAction<IAddFormComponentAction>(
    `${moduleName}/addFormComponent`,
  ),
  addFormComponents: createAction<IAddFormComponentsAction>(
    `${moduleName}/addFormComponents`,
  ),
  addFormContainer: createAction<IAddFormContainerAction>(
    `${moduleName}/addFormContainer`,
  ),
  ...
  deleteFormComponent: createAction<IDeleteComponentAction>(
    `${moduleName}/deleteFormComponent`,
  ),
  deleteFormContainer: createAction<IDeleteContainerAction>(
    `${moduleName}/deleteFormContainer`,
  ),
  ...
  updateActiveList: createAction<IUpdateActiveListAction>(
    `${moduleName}/updateActiveList`,
  ),
  ...
  updateLayoutName: createAction<IUpdateLayoutNameAction>(
    `${moduleName}/updateLayoutName`,
  ),
};
