...
export const actions = {
  addActiveFormContainer: createAction<IAddActiveFormContainerAction>(`${moduleName}/addActiveFormContainer`),
  addApplicationMetadata: createAction<IAddApplicationMetadataAction>(`${moduleName}/addApplicationMetadata`),
  ...
  deleteApplicationMetadata: createAction<IDeleteApplicationMetadataAction>(`${moduleName}/deleteApplicationMetadata`),
  ...
  updateApplicationMetadata: createAction<IUpdateApplicationMetadaAction>(`${moduleName}/updateApplicationMetadata`),
  updateApplicationMetadataFulfilled: createAction(`${moduleName}/updateApplicationMetadataFulfilled`),
  updateFormComponentId: createAction<IUpdateFormComponentIdAction>(`${moduleName}/updateFormComponentId`),
