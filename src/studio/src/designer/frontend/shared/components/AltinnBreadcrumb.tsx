...
interface IAltinnBreadcrumbComponentProvidedProps
...
export class AltinnBreadcrumb extends React.Component<IAltinnBreadcrumbComponentProvidedProps> {
  public render() {
      ...
      <Grid item={true} className={classNames(this.props.className)}>
        <Typography>
          {this.props.firstLink ? (
            ...
            <span className={classes.sidePadding}>
              {this.props.firstLinkTxt}
            </span>
          )}{' '}
