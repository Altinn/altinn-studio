...
export class AltinnIconButton extends React.Component<IAltinnIconButtonComponentProvidedProps> {
  public render() {
    ...
    return (
      ...
      >
        <i
          className={classNames(this.props.iconClass, classes.dottedBtnIcon)}
        />
        {this.props.btnText}
      </Button>
    );
