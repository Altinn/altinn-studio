...
const { APP_DEVELOPMENT_BASENAME, DASHBOARD_BASENAME } = require('../../packages/shared/constants');
...
module.exports = (middlewares, devServer) => {
  ...
  app.get(
    datamodelGetPath(':owner', ':repo', '/App/models/:filename'),
    require('./routes/get-datamodel')
  );
  app.get(datamodelsPath(':owner', ':repo'), require('./routes/get-datamodels'));
  app.get(frontendLangPath(':locale'), (req, res) =>
    res.json(require(`../../language/src/${req.params.locale}.json`))
  );
  ...
  app.get(serviceNamePath(':owner', ':repo'), (req, res) =>
