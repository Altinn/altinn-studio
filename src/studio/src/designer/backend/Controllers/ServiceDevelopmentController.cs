...
namespace Altinn.Studio.Designer.Controllers
{
    ...
    public class ServiceDevelopmentController : Controller
    {
        ...
        /// </summary>
        /// <param name="org">Unique identifier of the organisation responsible for the app.</param>
        /// <param name="app">the name of the local repository to reset</param>
        /// <returns>True if the reset was successful, otherwise false.</returns>
        public ActionResult<HttpResponseMessage> ResetLocalRepository(string org, string app)
        {
          try 
          {
            _repository.ResetLocalRepository(org, app);
            return new HttpResponseMessage(HttpStatusCode.OK);
          }
          catch (Exception)
          {
