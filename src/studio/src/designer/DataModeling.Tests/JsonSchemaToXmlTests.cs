...
namespace DataModeling.Tests
{
    public class JsonSchemaToXmlTests
    {
        ...
        {
            await TestFiles("Model/JsonSchema/General/SimpleAll.json", "Model/XmlSchema/General/SimpleAll.xsd");
        }
        ...
        {
            await TestFiles("Model/JsonSchema/General/Any.json", "Model/XmlSchema/General/Any.xsd");
        }

        [Fact(Skip = "Unhandled attributes ends up on schema, not on the root element. #6890")]
        public async Task Attributes()
        {
            await TestFiles("Model/JsonSchema/General/Attributes.json", "Model/XmlSchema/General/Attributes.xsd");
        }

        [Fact]
        public async Task BuiltinTypes()
        {
            await TestFiles("Model/JsonSchema/General/BuiltinTypes.json", "Model/XmlSchema/General/BuiltinTypes.xsd");
        }
        ...
        {
            await TestFiles("Model/JsonSchema/General/ComplexContentExtension.json", "Model/XmlSchema/General/ComplexContentExtension.xsd");
        }

        [Fact(Skip = "Needs analyzing")]
        public async Task ComplexContentRestriction()
        {
            await TestFiles("Model/JsonSchema/General/ComplexContentRestriction.json", "Model/XmlSchema/General/ComplexContentRestriction.xsd");
        }

        [Fact(Skip = "Fails to recognize array type and support xsd:list #6891")]
        public async Task ComplexSchema()
        {
            await TestFiles("Model/JsonSchema/General/ComplexSchema.json", "Model/XmlSchema/General/ComplexSchema.xsd");
        }

        [Fact(Skip = "We currently don't support group element. Ref. #6892")]
        public async Task Definitions()
        {
            await TestFiles("Model/JsonSchema/General/Definitions.json", "Model/XmlSchema/General/Definitions.xsd");
        }

        [Fact(Skip = "The provided example is an OR schema which is currently not supported.")]
        public async Task ElementAnnotation()
        {
            await TestFiles("Model/JsonSchema/General/ElementAnnotation.json", "Model/XmlSchema/General/ElementAnnotation.xsd");
        }

        [Fact]
        public async Task SimpleTypeRestrictions()
        {
            await TestFiles("Model/JsonSchema/General/SimpleTypeRestrictions.json", "Model/XmlSchema/General/SimpleTypeRestrictions.xsd");
        }

        [Fact]
        public async Task SimpleSequence()
        {
            await TestFiles("Model/JsonSchema/General/SimpleSequence.json", "Model/XmlSchema/General/SimpleSequence.xsd");
        }

        [Fact(Skip = "Nested sequence is currently not supported while maintaing the sequences. #6894")]
        public async Task NestedSequence()
        {
            await TestFiles("Model/JsonSchema/General/NestedSequence.json", "Model/XmlSchema/General/NestedSequence.xsd");
        }

        [Fact(Skip = "Nested sequence is currently not supported while maintaing the sequences. #6894")]
        public async Task NestedSequences()
        {
            await TestFiles("Model/JsonSchema/General/NestedSequences.json", "Model/XmlSchema/General/NestedSequences.xsd");
        }

        [Fact(Skip = "Nested sequence is currently not supported while maintaing the sequences. #6894")]
        public async Task NestedWithOptionalSequence()
        {
            await TestFiles("Model/JsonSchema/General/NestedWithOptionalSequence.json", "Model/XmlSchema/General/NestedWithOptionalSequence.xsd");
        }

        [Fact(Skip = "Nested sequence is currently not supported while maintaing the sequences. #6894")]
        public async Task NestedWithArraySequence()
        {
            await TestFiles("Model/JsonSchema/General/NestedWithArraySequence.json", "Model/XmlSchema/General/NestedWithArraySequence.xsd");
        }

        [Fact]
        public async Task SimpleContentExtension()
        {
            await TestFiles("Model/JsonSchema/General/SimpleContentExtension.json", "Model/XmlSchema/General/SimpleContentExtension.xsd");
        }

        [Fact]
        public async Task SimpleContentRestriction()
        {
            await TestFiles("Model/JsonSchema/General/SimpleContentRestriction.json", "Model/XmlSchema/General/SimpleContentRestriction.fromJson.xsd");
        }

        [Fact(Skip = "We currently don't support xsd:list #6891")]
        public async Task SimpleTypeList()
        {
            await TestFiles("Model/JsonSchema/General/SimpleTypeList.json", "Model/XmlSchema/General/SimpleTypeList.xsd");
        }

        [Fact]
        public async Task SchemaWithTargetNamespace()
        {
            await TestFiles("Model/JsonSchema/General/SchemaExampleWithTargetNamespace.json", "Model/XmlSchema/General/SchemaExampleWithTargetNamespace.xsd");
        }
    }
}
