...
namespace DataModeling.Tests
{
    public class XmlSchemaToJsonTests: FluentTestsBase<XmlSchemaToJsonTests>
    {
        ...
        [InlineData("Model/XmlSchema/General/SchemaWithTargetNamespace.xsd", "Model/JsonSchema/General/SchemaWithTargetNamespace.json", "Test to verify conversion from XSD to JSON Schema - feature: SchemaWithTargetNamespace")]
