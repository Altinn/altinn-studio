...
func TestRunWorkflow_StudioctlLikeRepo_LocalRepo(t *testing.T) {
	...
	expectedArtifacts := []string{
		...
		"app-manager-linux-amd64",
		"app-manager-linux-arm64",
		"app-manager-darwin-amd64",
		"app-manager-darwin-arm64",
		"app-manager-windows-amd64.exe",
		"app-manager-windows-arm64.exe",
