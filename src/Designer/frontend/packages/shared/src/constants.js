...
export const DEFAULT_RIGHTS_DESCRIPTION = {
  nb: 'Ved å gi tilgang til denne tjenesten gir du en annen person fullmakt til å bruke den på dine/virksomhetens vegne. Les beskrivelsen av tjenesten for mer informasjon om hva tilgangen innebærer.',
  nn: 'Når du gir tilgang til denne tenesta, gjev du ein annan person fullmakt til å bruka ho på dine vegner. Les skildringa av tenesta for meir informasjon om kva tilgangen inneber.',
