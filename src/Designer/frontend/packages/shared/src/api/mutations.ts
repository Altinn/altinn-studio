...
export const addDataTypeToAppMetadata = (org: string, app: string, dataTypeId: string, taskId: string, allowedContributors?: Array<string>, allowedContentTypes?: Array<string>) => post(processEditorDataTypePath(org, app, dataTypeId, taskId, allowedContentTypes), allowedContributors);
