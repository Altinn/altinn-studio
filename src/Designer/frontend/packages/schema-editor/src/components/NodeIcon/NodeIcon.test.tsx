import type { CombinationNode, ReferenceNode, UiSchemaNode } from '@altinn/schema-model/index';
import { CombinationKind, FieldType, ObjectKind } from '@altinn/schema-model/index';
import React from 'react';
import { render, screen } from '@testing-library/react';
import type { NodeIconProps } from './index';
