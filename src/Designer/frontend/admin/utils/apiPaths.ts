...
export const appMetricsPath = (org: string, env: string, app: string, time: number) =>
  `${adminApiBasePath}/metrics/${org}/${env}/app?app=${app}&time=${time}`; // Get
export const metricsPath = (org: string, env: string, time: number) =>
  `${adminApiBasePath}/metrics/${org}/${env}?time=${time}`; // Get
