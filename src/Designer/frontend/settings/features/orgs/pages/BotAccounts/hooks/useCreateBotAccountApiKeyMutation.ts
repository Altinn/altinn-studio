...
import type { CreateBotAccountApiKeyRequest, CreateBotAccountApiKeyResponse } from 'app-shared/types/BotAccount';
...
export const useCreateBotAccountApiKeyMutation = (org: string, botAccountId: string) => {
  ...
  return useMutation<CreateBotAccountApiKeyResponse, AxiosError<ApiError>, CreateBotAccountApiKeyRequest>({
