...
export const mockChatThreads: ChatThread[] = [
  {
    ...
    createdAt: '2025-10-01T09:59:00.000Z',
    messages: [
      {
      ...
      },
      {
        ...
        createdAt: '2025-10-01T10:01:00.000Z',
        filesChanged: [],
      },
      {
        author: MessageAuthor.User,
        ...
        createdAt: '2025-10-01T10:02:00.000Z',
        allowAppChanges: false,
      },
      {
        author: MessageAuthor.Assistant,
        ...
        createdAt: '2025-10-01T10:03:00.000Z',
        filesChanged: [],
      },
    ],
  },
  {
    ...
    createdAt: '2025-09-30T14:29:00.000Z',
    messages: [
      {
        author: MessageAuthor.Assistant,
        content: mockTexts.assistantFirstMessage,
      ...
      },
      {
        ...
        createdAt: '2025-09-30T14:31:00.000Z',
        filesChanged: [],
      },
    ],
  },
