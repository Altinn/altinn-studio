...
export function useUploadCodeListNameErrorMessage(): (
  fileNameError: FileNameErrorResult | null,
) => string | undefined {
  ...
  return (fileNameError: FileNameErrorResult | null): string | undefined =>
    fileNameError ? errorMessages[fileNameError] : undefined;
}
