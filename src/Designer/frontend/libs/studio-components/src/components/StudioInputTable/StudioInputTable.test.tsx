...
describe('StudioInputTable', () => {
  ...
  describe('Forwards the refs to the input elements', () => {
    ...
    const testCases: {
      ...
      checkbox: {
        render: (ref) => renderSingleCheckboxCell({ value: 'test', label: testLabel }, ref),
  ...
  describe('Triggers event functions for input level and table level events', () => {
    ...
    const testCases: {
      ...
      numberfield: {
        change: {
          render: (onChange) => renderSingleNumberfieldCell({ label: 'test', onChange }),
      ...
      checkbox: {
        change: {
          render: (onChange) =>
            renderSingleCheckboxCell({ value: 'test', label: 'test', onChange }),
          action: (user) => user.click(screen.getByRole('checkbox')),
        },
        focus: {
          render: (onFocus) => renderSingleCheckboxCell({ value: 'test', label: 'test', onFocus }),
          action: (user) => user.click(screen.getByRole('checkbox')),
        },
        blur: {
          render: (onBlur) => renderSingleCheckboxCell({ value: 'test', label: 'test', onBlur }),
          action: async (user) => {
