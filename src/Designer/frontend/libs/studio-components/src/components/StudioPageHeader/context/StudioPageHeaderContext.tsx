...
export const StudioPageHeaderContext = createContext<
  Partial<StudioPageHeaderContextProps> | undefined
>(undefined);
...
export const StudioPageHeaderContextProvider = ({
  children,
  variant,
}: StudioPageHeaderContextProviderProps): React.ReactElement => {
  return (
