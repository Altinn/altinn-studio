...
export const domListId = (baseId: string, id: string): string => `${baseId}-${id}-list`;
export const domItemId = (baseId: string, id: string): string => `${baseId}-${id}-listitem`;
...
export const domItemClass = (baseId: string): string =>
  `${replaceColonsWithUnderscores(baseId)}-listitem`;
export const domListClass = (baseId: string): string =>
  `${replaceColonsWithUnderscores(baseId)}-list`;
