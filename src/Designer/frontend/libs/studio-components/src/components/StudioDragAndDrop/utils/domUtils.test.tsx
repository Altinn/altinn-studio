...
const List = ({ baseId = defaultBaseId, id, children }: TestComponentProps): React.ReactElement => (
  <div className={domListClass(baseId)} id={domListId(baseId, id)}>
    {children}
  </div>
);
const Item = ({ baseId = defaultBaseId, id, children }: TestComponentProps): React.ReactElement => (
