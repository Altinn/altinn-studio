...
import { StudioContentMenu, type StudioContentMenuLinkTabProps } from './index';
      ...
      linkTabs: [
        {
          ...tab1,
          tabId: tab1Id,
          renderTab: (props): ReactElement => <a href={link} {...props} />,
        },
      ],
    });
...
const renderStudioContentMenu = ({
  buttonTabs = [],
  linkTabs = [],
}: Partial<RenderStudioContentMenuProps<StudioMenuTabName>> = {}): void => {
  render(
