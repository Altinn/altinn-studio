  ...
  projects: selectProjects([
    ...
    },
    {
      ...
      use: {
        ...devices['Desktop Chrome'],
        storageState: '.playwright/auth/user.json',
        testAppName: AppNames.DATA_MODEL_V9_APP,
    ...
    },
    {
      ...
      use: {
        ...devices['Desktop Chrome'],
        storageState: '.playwright/auth/user.json',
        testAppName: AppNames.DASHBOARD_V9_APP,
        testAppTemplate: AppTemplate.V9,
        headless: true,
      },
    },
    ...
    {
      name: TestNames.MAIN_NAVIGATION_BETWEEN_SUB_APPS_V9,
      dependencies: [TestNames.SETUP],
      testDir: './tests/main-navigation-between-sub-apps/',
      testMatch: '*.spec.ts',
      use: {
        ...devices['Desktop Chrome'],
        storageState: '.playwright/auth/user.json',
        testAppName: AppNames.MAIN_NAVIGATION_V9_APP,
        testAppTemplate: AppTemplate.V9,
        headless: true,
      },
    },
    ...
    },
    {
      ...
      use: {
        ...devices['Desktop Chrome'],
        storageState: '.playwright/auth/user.json',
        testAppName: AppNames.GIT_SYNC_V9_APP,
        testAppTemplate: AppTemplate.V9,
        headless: true,
      },
    },
    ...
    {
      name: TestNames.APP_SETTINGS_V9,
      dependencies: [TestNames.SETUP],
      testDir: './tests/app-settings/',
      testMatch: '*.spec.ts',
      use: {
        ...devices['Desktop Chrome'],
        storageState: '.playwright/auth/user.json',
        testAppName: AppNames.APP_SETTINGS_V9_APP,
        testAppTemplate: AppTemplate.V9,
        headless: true,
      },
    },
    ...
    },
    {
      ...
      use: {
        ...devices['Desktop Chrome'],
        storageState: '.playwright/auth/user.json',
        testAppName: AppNames.ORG_LIBRARY_V9,
        testAppTemplate: AppTemplate.V9,
        headless: true,
      },
    },
    ...
    },
    {
      ...
      use: {
        ...devices['Desktop Chrome'],
        storageState: '.playwright/auth/user.json',
        testAppName: AppNames.BRANCHING_V9_APP,
        testAppTemplate: AppTemplate.V9,
        headless: true,
      },
    },
