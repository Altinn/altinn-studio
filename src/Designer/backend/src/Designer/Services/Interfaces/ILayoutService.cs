...
namespace Altinn.Studio.Designer.Services.Interfaces
{
    public interface ILayoutService
    {
        ...
        public Task<bool> IsLayoutUsingPageGroups(AltinnRepoEditingContext editingContext, string layoutSetId);
        ...
        /// </summary>
        public Task ConvertPagesToPageGroups(AltinnRepoEditingContext editingContext, string layoutSetId);
        ...
        /// </summary>
        public Task ConvertPageGroupsToPages(AltinnRepoEditingContext editingContext, string layoutSetId);
    }
}
