...
namespace Altinn.Studio.Designer.Configuration.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        {
            Func<IServiceCollection, IConfiguration, string, IServiceCollection> registerSettingsMethodObject =
            ...
            where TOption : class, new()
        {
            ...
            services.TryAddScoped(
                typeof(TOption),
                svc => ((IOptionsSnapshot<object>)svc.GetService(typeof(IOptionsSnapshot<TOption>)))!.Value
            );
        }
