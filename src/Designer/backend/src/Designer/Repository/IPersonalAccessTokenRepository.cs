...
public interface IPersonalAccessTokenRepository
{
    ...
    Task<List<PersonalAccessTokenDbModel>> GetByUserAccountIdAsync(Guid userAccountId, PersonalAccessTokenType? tokenType = null, CancellationToken cancellationToken = default);
    Task<PersonalAccessTokenDbModel> CreateAsync(PersonalAccessTokenDbModel model, CancellationToken cancellationToken = default);
