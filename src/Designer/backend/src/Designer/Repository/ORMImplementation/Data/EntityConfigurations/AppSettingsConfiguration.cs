...
public class AppSettingsConfiguration : IEntityTypeConfiguration<AppSettingsDbModel>
{
    public void Configure(EntityTypeBuilder<AppSettingsDbModel> builder)
    {
        ...
        builder.Property(e => e.UndeployOnInactivity)
        ...
        builder.HasIndex(e => new { e.Org, e.App }, "idx_app_settings_org_app_global")
            .HasFilter("\"environment\" IS NULL")
            .IsUnique();

        builder.HasIndex(e => new { e.Org, e.App, e.Environment }, "idx_app_settings_org_app_environment")
