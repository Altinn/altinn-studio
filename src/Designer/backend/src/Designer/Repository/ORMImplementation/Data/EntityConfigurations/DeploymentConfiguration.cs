...
public class DeploymentConfiguration : IEntityTypeConfiguration<DeploymentDbModel>
{
    public void Configure(EntityTypeBuilder<DeploymentDbModel> builder)
    {
        ...
        builder.Property(e => e.EnvName).HasColumnType("character varying").HasColumnName("envname");

        builder.Property(e => e.Buildid).HasColumnType("character varying").HasColumnName("buildid");

        builder.Property(e => e.Buildresult).HasColumnType("character varying").HasColumnName("buildresult");
        ...
        builder.Property(e => e.Tagname).HasColumnType("character varying").HasColumnName("tagname");

        builder.Property(e => e.CreatedBy).HasColumnType("character varying").HasColumnName("created_by");

        builder.Property(e => e.InternalBuildId).HasColumnName("internal_build_id");
