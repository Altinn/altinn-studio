...
public class DeployEventConfiguration : IEntityTypeConfiguration<DeployEventDbModel>
{
    public void Configure(EntityTypeBuilder<DeployEventDbModel> builder)
    {
        ...
        builder.Property(e => e.DeploymentSequenceNo).HasColumnName("deployment_sequenceno").IsRequired();

        builder.Property(e => e.EventType).HasColumnType("character varying").HasColumnName("event_type").IsRequired();

        builder.Property(e => e.Message).HasColumnType("text").HasColumnName("message");
        ...
        builder.Property(e => e.Origin).HasColumnType("character varying").HasColumnName("origin").IsRequired();

        builder
            .HasOne(e => e.Deployment)
            .WithMany(d => d.Events)
