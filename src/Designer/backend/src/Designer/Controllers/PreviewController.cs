...
) : Controller
{
    ...
    public async Task<IActionResult> AppFrontendSpecificPreview(string org, string app)
    {
        ...
        // v9 apps are no longer served via a static index.cshtml. The HTML is generated by the
        // app backend's HomeController together with global bootstrap state on the window object.
