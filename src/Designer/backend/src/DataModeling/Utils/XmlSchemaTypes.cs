...
public static class XmlSchemaTypes
{
    ...
    public static IEnumerable<string> AllKnownTypes =>
        typeof(XmlSchemaTypes)
            .GetFields()
            .Select(fieldInfo => typeof(XmlSchemaTypes).GetField(fieldInfo.Name)!.GetValue(null) as string)
            .ToList();
    ...
    public static IEnumerable<string> DateTypes =>
        new List<string> { Date, DateTime, Duration, GDay, GMonth, GMonthDay, GYear, GYearMonth, Time };
    ...
    public static IEnumerable<string> NumericTypesWithFractions => new List<string> { Decimal, Float, Double };
