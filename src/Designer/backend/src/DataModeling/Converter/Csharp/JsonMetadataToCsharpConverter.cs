...
public class JsonMetadataToCsharpConverter : IModelMetadataToCsharpConverter
{
    ...
    )
    {
        ...
        // The auto-generated header marks the file as generated code, which code-style analyzers and
        // IDEs leave alone. Without it, an app with implicit usings enabled sees every using directive
        // below that the SDK already imports globally flagged as unnecessary (IDE0005). The directives
        // stay: the generated file must also compile in an app without implicit usings.
        writer
            .AppendLine("// <auto-generated>")
            .AppendLine("//     This code was generated by Altinn Studio from the data model's JSON Schema.")
            .AppendLine("//     Changes to this file will be lost when the model is regenerated.")
            .AppendLine("// </auto-generated>")
            .AppendLine(useNullableReferenceTypes ? "#nullable enable" : "#nullable disable")
