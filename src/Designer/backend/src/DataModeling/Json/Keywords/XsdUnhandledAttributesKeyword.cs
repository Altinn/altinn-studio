...
/// </summary>
public sealed class XsdUnhandledAttributesKeyword : IKeywordHandler
{
    public static readonly XsdUnhandledAttributesKeyword Instance = new();

    /// <summary>
    /// The name of the keyword
    /// </summary>
    internal const string KeywordName = "@xsdUnhandledAttributes";
