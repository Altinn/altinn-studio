...
public class Json2XmlTestData : IEnumerable<object[]>
{
    public IEnumerator<object[]> GetEnumerator()
    {
        ...
        // yield return new object[] { "Model/JsonSchema/General/NestedSequence.json", "Model/XmlSchema/General/NestedSequence.xsd" }; // "Nested sequence is currently not supported while maintaining the sequences. #6894"
        // yield return new object[] { "Model/JsonSchema/General/NestedSequences.json", "Model/XmlSchema/General/NestedSequences.xsd" }; // "Nested sequence is currently not supported while maintaining the sequences. #6894"
        // yield return new object[] { "Model/JsonSchema/General/NestedWithOptionalSequence.json", "Model/XmlSchema/General/NestedWithOptionalSequence.xsd" }; //  "Nested sequence is currently not supported while maintaining the sequences. #6894"
        // yield return new object[] { "Model/JsonSchema/General/NestedWithArraySequence.json", "Model/XmlSchema/General/NestedWithArraySequence.xsd" }; //  "Nested sequence is currently not supported while maintaining the sequences. #6894"
