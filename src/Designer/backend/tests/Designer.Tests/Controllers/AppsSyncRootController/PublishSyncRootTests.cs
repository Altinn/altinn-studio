...
public class PublishSyncRootTests
    : DbDesignerEndpointsTestsBase<PublishSyncRootTests>,
        ...
        IClassFixture<MockServerFixture>
{
    ...
    private static string VersionPrefix(string org, string environment) =>
        $"/designer/api/v1/{org}/internals/sync-gitops/{environment}/push";

    public PublishSyncRootTests(
    ...
    protected override void ConfigureTestServices(IServiceCollection services)
    {
        ...
        _userOrganizationServiceMock.Setup(s => s.UserIsMemberOfOrganization("ttd")).ReturnsAsync(true);
        services.AddSingleton(_userOrganizationServiceMock.Object);
    }

    [Theory]
    [MemberData(nameof(TestData))]
    public async Task PublishSyncRoot_ShouldQueueBuildAndReturnAccepted(
        string org,
        string environment,
