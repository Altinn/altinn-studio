...
public class ProcessDataTypesChangedNotifyTests
    : DesignerEndpointsTestsBase<ProcessDataTypesChangedNotifyTests>,
        IClassFixture<WebApplicationFactory<Program>>
{
    ...
    public async Task ProcessDataTypesChangedNotify_ShouldReturnOk(
        string org,
        string app,
        string developer,
        DataTypesChange metadata
    )
    {
