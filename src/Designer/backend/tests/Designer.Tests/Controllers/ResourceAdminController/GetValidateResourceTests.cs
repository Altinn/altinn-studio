...
namespace Designer.Tests.Controllers.ResourceAdminController
{
    public class GetValidateResourceTests : ResourceAdminControllerTestsBaseClass<GetValidateResourceTests>, IClassFixture<WebApplicationFactory<Program>>
    {
        ...
        public async Task ValidateServiceResourceById_IsValid()
        {
            ...
            RepositoryMock.Setup(r => r.GetServiceResourceById(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<System.Threading.CancellationToken>())).Returns(Task.FromResult(GetServiceResourceForValidationTest(true)));
        ...
        public async Task ValidateServiceResourceById_IsInValid()
        {
            ...
            RepositoryMock.Setup(r => r.GetServiceResourceById(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<System.Threading.CancellationToken>())).Returns(Task.FromResult(GetServiceResourceForValidationTest(false)));
