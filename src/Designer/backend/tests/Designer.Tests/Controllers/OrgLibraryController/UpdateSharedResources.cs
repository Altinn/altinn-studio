...
public class UpdateSharedResources(WebApplicationFactory<Program> factory) : DesignerEndpointsTestsBase<UpdateSharedResources>(factory), IClassFixture<WebApplicationFactory<Program>>
{
