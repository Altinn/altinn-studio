...
public class GetCodeListsNewTests : DesignerEndpointsTestsBase<GetCodeListsNewTests>, IClassFixture<WebApplicationFactory<Program>>
{
    ...
    public async Task Get_Returns200OK_WhenRetrievingCodeLists()
    {
        ...
        _orgCodeListService
            .Setup(service => service.GetCodeListsNew(Org, It.IsAny<CancellationToken>()))
        ...
        _orgCodeListService.Verify(service => service.GetCodeListsNew(Org, It.IsAny<CancellationToken>()), Times.Once);
    }
