...
public class AnsattPortenControllerTestsBase<TControllerTest> : DesignerEndpointsTestsBase<TControllerTest>
    where TControllerTest : class
{
    public AnsattPortenControllerTestsBase(WebApplicationFactory<Program> factory)
        : base(factory)
    {
