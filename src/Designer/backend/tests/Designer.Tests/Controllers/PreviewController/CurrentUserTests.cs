...
namespace Designer.Tests.Controllers.PreviewController
{
    public class CurrentUserTests
        : PreviewControllerTestsBase<CurrentUserTests>,
            IClassFixture<WebApplicationFactory<Program>>
    {
        public CurrentUserTests(WebApplicationFactory<Program> factory)
            : base(factory) { }
        ...
        public async Task Get_CurrentUser_Ok()
        {
            ...
            UserProfile currentUser = JsonConvert.DeserializeObject<UserProfile>(
