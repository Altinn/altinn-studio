...
public class UpdateResourceTests(WebApplicationFactory<Program> factory)
    : DesignerEndpointsTestsBase<UpdateResourceTests>(factory),
        IClassFixture<WebApplicationFactory<Program>>
{
    [Theory]
    [MemberData(nameof(Data))]
    public async Task UpdateResource_Returns200OK_WithValidInput(
        string org,
        string developer,
        string repo,
        string lang,
    ...
    public async Task UpdateResource_Returns200OK_ForTextsThatHaveVariables(
        string org,
        string developer,
        string repo,
        string lang,
    ...
    )
    {
        ...
        string originalFile = TestDataHelper.GetFileFromRepo(
            targetOrg,
            targetRepository,
            developer,
            RelativePath(lang)
