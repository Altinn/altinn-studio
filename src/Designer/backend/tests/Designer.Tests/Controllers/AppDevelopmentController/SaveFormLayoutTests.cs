...
namespace Designer.Tests.Controllers.AppDevelopmentController
{
    public class SaveFormLayoutTestsBase(WebApplicationFactory<Program> factory)
        : DesignerEndpointsTestsBase<SaveFormLayoutTestsBase>(factory),
            IClassFixture<WebApplicationFactory<Program>>
    {
        ...
        )
        {
            ...
            var payload = new JsonObject { ["componentIdsChange"] = null, ["layout"] = JsonNode.Parse(layout) };
        ...
        )
        {
            ...
            var payload = new JsonObject
            {
                ...
                {
                    new JsonObject { ["oldComponentId"] = "Test", ["newComponentId"] = "Test2" },
                },
        ...
        public async Task SaveFormLayoutWithDeletedComponent_DeletesAssociatedSummary2Components_ReturnsOk(
            string org,
            string developer,
            string layoutSetName,
            string layoutName,
        ...
        )
        {
            ...
            string layout = TestDataHelper.GetFileFromRepo(
                org,
                app,
                developer,
                $"App/ui/{layoutSetName}/layouts/{layoutName}.json"
            ...
            var payload = new JsonObject
            {
                ["componentIdsChange"] = new JsonArray() { new JsonObject { ["oldComponentId"] = componentId } },
        ...
        public async Task SaveFormLayoutWithUpdatedComponentName_UpdatesAssociatedSummary2Components_ReturnsOk(
            string org,
            string developer,
            string layoutSetName,
            string layoutName,
        ...
        )
        {
            ...
            var payload = new JsonObject
            {
                ["componentIdsChange"] = new JsonArray()
                {
                    new JsonObject { ["oldComponentId"] = componentId, ["newComponentId"] = newComponentId },
                },
        ...
        public async Task SaveFormLayoutWithNewPageLanguageUpdate_ReturnsOk(
            string org,
            string app,
            string developer,
            string layoutName,
        ...
        )
        {
            ...
            Assert.True(
                TestDataHelper.FileExistsInRepo(org, targetRepository, developer, "App/config/texts/resource.nb.json")
            );
            ...
            string newTextFile = TestDataHelper.GetFileFromRepo(
                org,
                targetRepository,
                developer,
                $"App/config/texts/resource.nb.json"
