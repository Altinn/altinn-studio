...
namespace Designer.Tests.Controllers.AlertsController
{
    public class NotifyAlertsUpdatedTests(WebApplicationFactory<Program> factory)
          : DesignerEndpointsTestsBase<NotifyAlertsUpdatedTests>(factory), IClassFixture<WebApplicationFactory<Program>>
    {
