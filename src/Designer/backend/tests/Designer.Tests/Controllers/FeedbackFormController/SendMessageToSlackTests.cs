        ...
        IClassFixture<MockServerFixture>
{
    ...
    public SendMessageToSlackTests(WebApplicationFactory<Program> factory, MockServerFixture mockServerFixture)
        : base(factory)
    {
    ...
    public async Task SendMessageToSlack_Should_ReturnOk()
    {
        ...
        var mockAnswers = new FeedbackForm { Answers = new Dictionary<string, string> { { "message", "test" } } };
