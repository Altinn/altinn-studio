...
public class AltinnOrgGitRepositoryTests : IDisposable
{
    ...
    [Theory]
    [InlineData("org-content", "nb")]
    public async Task TextResourceFileExists_WithRepoThatHasTextResources_ShouldReturnTrue(
        string repository,
        string language
    )
    {
    ...
    public async Task CreatCodeList_WithEmptyRepo_ShouldCreateCodeList(string repository, string codeListId)
    {
        ...
        string fileContent = TestDataHelper.GetFileFromRepo(
            ...
            targetRepository,
            Developer,
            CodeListUtils.FilePathWithTextResources(codeListId)
        );
    ...
    public async Task UpdateCodeListId_WithExistingCodeList_ShouldUpdateCodeListId(
        string repository,
        string codeListId,
    ...
    public async Task DeleteCodeList_WithExistingCodeList_ShouldDeleteCodeList(string repository, string codeListId)
    {
        ...
        // Assert
        string repositoryDir = TestDataHelper.GetTestDataRepositoryDirectory(TargetOrg, targetRepository, Developer);
        string codeListFilePath = Path.Join(repositoryDir, CodeListUtils.FilePathWithTextResources(codeListId));
