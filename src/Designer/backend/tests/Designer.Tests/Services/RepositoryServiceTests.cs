...
namespace Designer.Tests.Services
{
    public class RepositoryServiceTests
    {
        ...
        public async Task CopyRepository_WithConfigJson_InRoot_UpdatesServiceConfiguration()
        {
            ...
            try
            {
                ...
                Assert.True(
                    ...
                    $"Before copying: config.json missing in source root: {configPath}"
                );
                ...
                ServiceConfiguration config = System.Text.Json.JsonSerializer.Deserialize<ServiceConfiguration>(
                    configJson,
                    options
                );
        ...
        public async Task CreateRepository_WithOneTemplate_AppliesTemplateOnce()
        {
            ...
            var repositoryService = GetServiceForTest(
                developer,
                customTemplateServiceMock: customTemplateServiceMock.Object
            );
        ...
        public async Task CreateRepository_WithMultipleTemplates_AppliesEachTemplateOnce()
        {
            ...
            customTemplateServiceMock
                .Setup(m =>
                    m.ApplyTemplateToRepository(It.IsAny<string>(), It.IsAny<string>(), org, repositoryName, developer)
                )
                .Returns(Task.CompletedTask);
