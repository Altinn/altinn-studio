...
{
    private readonly WebApplicationFactory<SourceControlLoggingDecorator> _webApplicationFactory =
    ...
    {
        (ISourceControl service, Mock<ILogger<SourceControlLoggingDecorator>> loggerMock) = GetService();
        AltinnAuthenticatedRepoEditingContext authenticatedEditingContext =
    ...
    public void DecoratedISourceControlService_CloneRemoteRepository2_LogsErrorWithAdditionalInfo()
    {
        ...
        try
        {
            service.CloneRemoteRepository(
                authenticatedEditingContext,
                "destination_path_should_not_exist",
                "branch_name_should_not_exist"
            );
        }
        catch { }
    ...
    public IServiceProvider GetServiceProvider(Mock<ILoggerFactory> loggerFactoryMock)
    {
        ...
        IServiceProvider services = _webApplicationFactory
