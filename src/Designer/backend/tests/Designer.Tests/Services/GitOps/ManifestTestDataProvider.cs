...
public class ManifestTestDataProvider
{
    ...
    public static TheoryData<AltinnRepoContext, Dictionary<string, string>> AppsManifestsTestData =>
        ...
        {
            {
                AltinnRepoContext.FromOrgRepo("ttd", "test-app"),
                LoadManifestsFromFolder("./apps/test-app/", "GitOps/Manifests/apps/test-app")
            },
            {
                AltinnRepoContext.FromOrgRepo("ttd", "test-app-2"),
                LoadManifestsFromFolder("./apps/test-app-2/", "GitOps/Manifests/apps/test-app-2")
            },
        };

    public static TheoryData<
        AltinnEnvironment,
        HashSet<AltinnRepoName>,
        Dictionary<string, string>
    > EnvironmentManifestsTestData =>
        new()
        {
            {
                ...
                {
                    AltinnRepoName.FromName("test-app"),
                    AltinnRepoName.FromName("test-app-2"),
                },
                LoadManifestsFromFolder("./prod", "GitOps/Manifests/prod")
            },
            {
                ...
                {
                    AltinnRepoName.FromName("test-app-2"),
                    AltinnRepoName.FromName("test-app-3"),
                },
