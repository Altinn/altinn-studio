...
FROM altinntjenestercontainerregistry.azurecr.io/altinn-studio-service-development:latest AS altinn-studio-service-development

# Altinn-Studio Dashboard
FROM altinntjenestercontainerregistry.azurecr.io/altinn-studio-dashboard:latest AS altinn-studio-dashboard
