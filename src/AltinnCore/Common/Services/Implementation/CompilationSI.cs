...
namespace AltinnCore.Common.Services.Implementation
{
    ...
    public class CompilationSI : Interfaces.ICompilation
    {
        ...
        {
            ModelMetadata serviceMetadata = _repository.GetModelMetadata(org, app);
            ...
            CopyDirectoryContents(_settings.GetMetadataPath(org, app, AuthenticationHelper.GetDeveloperUserName(_httpContextAccessor.HttpContext)), tempDirPath + ServiceRepositorySettings.MODEL_METADATA_FOLDER_PATH);
