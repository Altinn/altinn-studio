...
namespace Altinn.App.Services.Interface
{
    ...
    public interface IAltinnApp
    {
        ...
        /// <param name="formData">The form data in json string.</param>
        /// <returns> The pages in sorted order.</returns>
        virtual async Task<List<string>> GetPageOrder(string org, string app, int instanceOwnerId, Guid instanceGuid, string layoutSetId, string currentPage, string dataTypeId, string formData)
        {
