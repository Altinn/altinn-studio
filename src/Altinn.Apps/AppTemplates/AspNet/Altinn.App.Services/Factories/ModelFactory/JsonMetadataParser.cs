...
namespace Altinn.App.Services.Factories.ModelFactory
{
    /// <summary>
    ...
    {
        private ServiceMetadata.ServiceMetadata _serviceMetadata;
        ...
        public string CreateModelFromMetadata(ServiceMetadata.ServiceMetadata serviceMetadata)
        {
