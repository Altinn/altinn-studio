...
namespace Altinn.App.Services.Factories.ModelFactory.Manatee.Json
{
    /// <summary>
    /// Defines the <code>infos</code> JSON Schema keyword. Based on Manatee.Json.Schema.DefinitionsKeyword
    /// </summary>
    [DebuggerDisplay("Name={Name}; Count={Count}")]
    public class InfoKeyword : Dictionary<string, string>, IJsonSchemaKeyword, IEquatable<InfoKeyword>
    {
        /// <summary>
        ...
        {
            return Equals(other as InfoKeyword);
        }
