...
namespace Altinn.App.Services.Interfaces
{
    ...
    public interface IRepository : IServicePackageRepository
    {
        ...
        bool CreateModel(string org, string app, ServiceMetadata.ServiceMetadata serviceMetadata, XDocument mainXsd);
        ...
        bool CreateServiceMetadata(ServiceMetadata.ServiceMetadata serviceMetadata);
        ...
        List<ServiceMetadata.ServiceMetadata> GetAvailableServices();
        ...
        /// <returns>A boolean indicating if saving was ok</returns>
        bool UpdateServiceMetadata(string org, string app, ServiceMetadata.ServiceMetadata serviceMetadata);
