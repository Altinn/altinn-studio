...
namespace Altinn.App.Services.Interface
{
    ...
    public interface IProcess
    {
        ...
        /// <summary>
        /// Starts the process and moves it to its first Task. If process is allready started operation is ignored.
        /// </summary>
        /// <param name="instance"></param>
        /// <param name="validStartEvent"></param>
        /// <param name="userContext"></param>
        /// <returns></returns>
        Task<Instance> ProcessStartAndNext(Instance instance, string validStartEvent, UserContext userContext);
