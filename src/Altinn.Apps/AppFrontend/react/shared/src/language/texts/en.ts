...
export function en() {
  return {
    ...
    instantiate: {
      ...
      authorization_error_rights: 'It looks like you do not have permission to start this app for {0}',
      authorization_error_ask: ' You can ask for the required rights from persons with access delegation rights within your organization.',
    ...
    receipt: {
      ...
      sender: 'Sender',
      subtitle: 'A copy of your receipt has been sent to your inbox',
