...
import { getCurrentDataTypeForApplication, getLayoutSetIdForApplication } from '../../src/utils/appMetadata';
...
describe('>>> utils/appmetadata.ts', () => {
  ...
  const instance: Partial<IInstance> = {
    ...
    process: {
      ...
      currentTask: { flow: 2, elementId: "Task_1", name: "Utfylling", altinnTaskType: "data"},
    } as any,
  }
