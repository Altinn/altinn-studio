...
export function nn() {
  return {
    ...
    'process_workflow.failure_kind.dependencyFailed': 'Eit tidlegare handsamingssteg feila',
    'process_workflow.failure_kind.engineFault': 'Teknisk feil i handsaminga',
