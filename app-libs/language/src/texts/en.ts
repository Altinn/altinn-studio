export function en() {
  return {
    ...
    'form_filler.organization_lookup_orgnr': 'organisation number',
    'form_filler.organization_lookup_name': 'organisation name',
    ...
    'instantiate.authorization_error_ask':
      'If you are representing a person it is the one you are representing that can give you the required rights to start this service. If you are you representing an organisation you have to ask for the required rights from persons with access delegation rights within your organisation.',
