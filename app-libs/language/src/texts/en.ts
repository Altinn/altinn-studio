export function en() {
  return {
    ...
    'process_workflow.advancing_title': 'We’re processing your request',
    'process_workflow.advancing_body':
      'This may take a little while. You don’t need to do anything – we’ll continue automatically when everything is ready.',
    ...
    'process_workflow.failure_kind.dependencyFailed': 'An earlier processing step failed',
    'process_workflow.failure_kind.engineFault': 'A technical error occurred during processing',
