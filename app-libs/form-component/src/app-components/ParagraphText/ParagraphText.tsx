...
export function ParagraphText({ children }: PropsWithChildren) {
  // The text resolver wraps inline content in a <span> (and plain strings are inline too); block-level
  // content (headings, lists, etc.) is not, and must be wrapped in a <div> rather than nested directly
  // inside a <p>.
