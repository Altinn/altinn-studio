...
If you want to work on creating apps locally, [app-template-dotnet](https://github.com/Altinn/app-template-dotnet) repo should be cloned locally and it should be referenced in appsettings.Development.json
```
{
   "GeneralSettings": {
