...
export const RightMenu = ({
  ...
  const addLangOptions = langOptions.filter(
    (x) => !availableLanguages.includes(x.value),
  );
  const canDeleteLang = (code) =>
    availableLanguages.length > 1 && code !== defaultLangCode;
  ...
  return (
    <aside className={classes.RightMenu__sidebar}>
      <div className={classes.RightMenu__verticalContent}>
        <header>
          <div className={classes["LangEditor__title-md"]}>
                  ...
                  <div className={classes.RightMenu__radio}>
                    ...
                    <AltinnConfirmDialog
                      ...
                      trigger={
                        <Button
                          variant={
                            canDeleteLang(langCode) ? "filled" : "outline"
                          }
