...
import { StudioToggleableTextfieldSchema } from '@studio/components';
...
export const PageConfigPanel = () => {
  ...
  const [{ data: layoutSchema }, { data: expressionSchema }] = useLayoutSchemaQuery();
  const { mutateAsync: saveLayout } = useFormLayoutMutation(
    org,
    app,
    layoutName,
    selectedLayoutSet,
  ...
  return (
    <>
      <div className={classes.header}>
        ...
        <HelpText title={''} className={classes.helpText}>
          {}
        </HelpText>
      </div>
      {layoutIsSelected && (
          ...
          <div className={classes.changePageId}>
            <StudioToggleableTextfieldSchema
              ...
              customValidation={(value: string) => {
                return t(getPageNameErrorKey(value, layoutName, layoutOrder));
              }}
            />
          </div>
