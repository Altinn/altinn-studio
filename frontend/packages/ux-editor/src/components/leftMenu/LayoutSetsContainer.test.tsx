...
describe('LayoutSetsContainer', () => {
  it('renders component', async () => {
    ...
    expect(await screen.findByRole('button', { name: layoutSetsMock.sets[0].id })).toBeInTheDocument();
    expect(await screen.findByRole('button', { name: layoutSetsMock.sets[1].id })).toBeInTheDocument();
  });
