...
import { StudioButton, StudioDeleteButton, StudioLink, StudioParagraph } from '@studio/components';
    ...
    >
      ...
      <StudioParagraph size='sm'>
        {layoutSetModel.dataType
          ? t('ux_editor.task_card.datamodel') + layoutSetModel.dataType
          : t('ux_editor.task_card.no_datamodel')}
      </StudioParagraph>
      <StudioLink>
        <StudioButton variant='primary'>Utform</StudioButton>
      </StudioLink>
    </StudioIconCard>
  );
};
