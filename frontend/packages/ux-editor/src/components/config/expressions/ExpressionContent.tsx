...
export const ExpressionContent = ({
  ...
  const allowToSpecifyExpression =
    ...
    Object.values(ExpressionFunction).includes(
      expressionElement.function as ExpressionFunction
    );
  ...
  const addDataSourceToDynamic = (
    dataSource: string,
    isComparable: boolean
  ) => {
    const newExpressionElement = addDataSource(
      expressionElement,
      dataSource,
      isComparable
    );
  ...
  const addDataSourceValueToDynamic = (
    dataSourceValue: string,
    isComparable: boolean
  ) => {
    const newExpressionElement = addDataSourceValue(
      expressionElement,
      dataSourceValue,
      isComparable
    );
            ...
            <div className={classes.expressionDetails}>
              <Select
                onChange={(dataSource: string) =>
                  addDataSourceToDynamic(dataSource, false)
                }
              ...
              {expressionElement.dataSource && (
                <DataSourceValue
                  ...
                  specifyDataSourceValue={(dataSourceValue) =>
                    addDataSourceValueToDynamic(dataSourceValue, false)
                  }
              ...
              {expressionElement.comparableDataSource && (
                <DataSourceValue
                  expressionElement={expressionElement}
                  currentDataSource={
                    expressionElement.comparableDataSource as DataSource
                  }
                  specifyDataSourceValue={(dataSourceValue) =>
                    addDataSourceValueToDynamic(dataSourceValue, true)
                  }
          ...
          <div className={classes.addExpression}>
            {showAddExpressionButton ? (
              <Button
                ...
                size="small"
                onClick={() =>
                  handleAddExpressionElement(dynamicOperator || Operator.And)
                }
              >
                <i
              ...
              <div className={classes.andOrToggleButtons}>
                <ToggleButtonGroup
                  ...
                  onChange={(value) =>
                    handleUpdateDynamicOperator(value as Operator)
                  }
