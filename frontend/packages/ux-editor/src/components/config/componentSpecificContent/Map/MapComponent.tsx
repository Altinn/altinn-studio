...
export const MapComponent = ({
  ...
  const handleCenterLocationChange = (
    value: number,
    propertyName: string,
  ): void => {
    handleComponentChange({
        ...
        <div className={classes.formGroup}>
          <FormField
            ...
            onChange={(value: number) =>
              handleCenterLocationChange(value, "latitude")
            }
          ...
          <FormField
            ...
            onChange={(value: number) =>
              handleCenterLocationChange(value, "longitude")
            }
        ...
        (layer, index): JSX.Element => (
          ...
          <LegacyFieldSet key={index} className={classes.fieldSet}>
            ...
            <FormField
              ...
              customValidationMessages={(errorCode: string) => {
                if (errorCode === "format")
                  return t("validation_errors.value_as_url");
              }}
            >
              {({ onChange }) => (
                <TextField
            ...
            <div className={classes.formGroup}>
              ...
              <FormField
                ...
                onChange={(value: string[]) =>
                  handleOnSubDomainChange(index, value)
                }
