...
describe('EditOptionChoice', () => {
  ...
  it('should editOptionsId to blank when removing choice', async () => {
    ...
    renderEditOptionChoice({ handleComponentChange: handleOptionsIdChange });
...
function renderEditOptionChoice<T extends ComponentType.Checkboxes | ComponentType.RadioButtons>({
  componentProps = {},
