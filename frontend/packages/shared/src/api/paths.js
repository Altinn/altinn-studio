...
export const altinn2DisableDelegationsPath = (org, serviceCode, serviceEditionCode, env) => `${basePath}/${org}/resources/altinn2/disabledelegations/${serviceCode}/${serviceEditionCode}/${env}`; // Post
