...
export const dataModelsPath = (org, app) => `${basePath}/${org}/${app}/datamodels/app-json`; // Get
export const dataModelsXsdPath = (org, app) => `${basePath}/${org}/${app}/datamodels/app-xsd`; // Get
