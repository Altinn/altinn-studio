...
export const resourceListPath = (org, useNewApi, ignoreGiteaFields) => `${apiBasePath}/${org}/resources/resourcelist?includeEnvResources=true&useNewApi=${useNewApi}&ignoreGiteaFields=${ignoreGiteaFields}`; // Get
