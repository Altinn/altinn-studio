...
export const deleteFormLayout = (org: string, app: string, layoutName: string) => del(formLayoutPath(org, app, layoutName));
...
export const saveFormLayout = (org: string, app: string, layoutName: string, payload: ExternalFormLayout) => post<void, ExternalFormLayout>(formLayoutPath(org, app, layoutName), payload);
export const saveFormLayoutSettings = (org: string, app: string, payload: ILayoutSettings) => post<ILayoutSettings>(layoutSettingsPath(org, app), payload);
export const saveRuleConfig = (org: string, app: string, payload: RuleConfig) => post<RuleConfig>(ruleConfigPath(org, app), payload);
...
export const updateFormLayoutName = (org: string, app: string, oldName: string, newName: string) => post<void, string>(formLayoutNamePath(org, app, oldName), JSON.stringify(newName), { headers: { 'Content-Type': 'application/json' } });
