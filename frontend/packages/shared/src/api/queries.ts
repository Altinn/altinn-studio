...
export const getFormLayoutSettings = (owner: string, app: string) => get<ILayoutSettings>(layoutSettingsPath(owner, app));
export const getFormLayouts = (owner: string, app: string) => get<FormLayoutsResponse>(formLayoutsPath(owner, app));
...
export const getRuleConfig = (owner: string, app: string) => get<RuleConfig>(ruleConfigPath(owner, app));
