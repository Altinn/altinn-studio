...
export const getAvailableOptionListTitlesInOrg = (owner: string): Promise<string[]> => Promise.resolve(listOfAvailableOptionListTitlesToImport); // Todo: Replace with real API call when endpoint is ready. https://github.com/Altinn/altinn-studio/issues/14885
