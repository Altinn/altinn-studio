...
export const getResourceList = (org: string, useNewApi: boolean, ignoreGiteaFields: boolean) => get<ResourceListItem[]>(resourceListPath(org, useNewApi, ignoreGiteaFields));
