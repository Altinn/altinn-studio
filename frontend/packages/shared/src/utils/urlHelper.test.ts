...
describe('Shared urlHelper.ts', () => {
  ...
  describe('returnUrlToMessagebox', () => {
    ...
    test('returnUrlToMessagebox() returning studio messagebox', () => {
      const origin = 'https://studio.localhost/tdd/tjeneste-20190826-1130';
      expect(returnUrlToMessagebox(origin)).toContain('studio.localhost');
    });
