...
export const queriesMock: ServicesContextProps = {
  ...
  getAccessLists: jest.fn(),
  getAccessList: jest.fn(),
  getAppLibVersion: jest.fn(),
  createAccessList: jest.fn(),
  updateAccessList: jest.fn(),
  deleteAccessList: jest.fn(),
  addAccessListMember: jest.fn(),
  removeAccessListMember: jest.fn(),
  getResourceAccessLists: jest.fn(),
  addResourceAccessList: jest.fn(),
  removeResourceAccessList: jest.fn(),
  getParties: jest.fn(),
  getSubParties: jest.fn(),
};
