...
export const header = {
  ...
  getCreateLink: () =>
    cy.findByRole("link", { name: texts["top_menu.create"] }),
  getDatamodelLink: () =>
    cy.findByRole("link", { name: texts["top_menu.datamodel"] }),
  getDeployButton: () =>
    cy.findByRole("button", { name: texts["top_menu.deploy"] }),
  ...
  getOpenRepoLink: () =>
    cy.findByRole("link", { name: texts["dashboard.open_repository"] }),
  getPreviewButton: () =>
    cy.findByRole("button", { name: texts["top_menu.preview"] }),
  ...
  getTextEditorLink: () =>
    cy.findByRole("link", { name: texts["top_menu.texts"] }),
