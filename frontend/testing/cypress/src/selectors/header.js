...
export const header = {
  ...
  getDescribeChangesField: () => cy.findByRole('textbox', { name: texts['sync_header.describe_and_validate'] }),
  getMenuItem,
  ...
  getValidateChangesButton: () => cy.findByRole('button', { name: texts['general.validate_changes'] }),
};
