...
export const DeployDropdown = ({
  ...
  const [isConfirmDeployDialogOpen, setIsConfirmDeployDialogOpen] =
    useState<boolean>();
        ...
        <AltinnConfirmDialog
          ...
          trigger={
            <Button
              disabled={disabled}
              onClick={() =>
                setIsConfirmDeployDialogOpen((prevState) => !prevState)
              }
        ...
        >
          <p>
            {appDeployedVersion
              ...
              : t("app_deploy_messages.deploy_confirmation_short", {
                  selectedImageTag,
                })}
          </p>
        </AltinnConfirmDialog>
        ...
        <div className={classes.deployStatusGridContainer}>
          ...
          <div>
            ...
            <Trans i18nKey={"app_deploy_messages.see_build_log"}>
              <a
                href={getAzureDevopsBuildResultUrl(
                  deployHistoryEntry?.build.id,
                )}
                target="_newTab"
