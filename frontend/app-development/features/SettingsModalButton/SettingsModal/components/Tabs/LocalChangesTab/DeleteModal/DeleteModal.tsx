      ...
      title={
        <div className={classes.titleWrapper}>
          ...
          <Heading level={1} size='xsmall'>
            {t('settings_modal.local_changes_tab_verification_modal_title')}
          </Heading>
        </div>
      }
    >
      <div className={classes.contentWrapper}>
        <TextField
          label={t('settings_modal.local_changes_tab_verification_modal_textfield_label')}
          value={nameToDelete}
        ...
        <div className={classes.buttonWrapper}>
          ...
          >
            {t('settings_modal.local_changes_tab_verification_modal_delete_button')}
          </Button>
