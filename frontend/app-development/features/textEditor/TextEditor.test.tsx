...
describe("TextEditor", () => {
  ...
  it("updates text resource when editing text", async () => {
    ...
    expect(upsertTextResources).toBeCalledWith(org, app, "nb", {
  ...
  it("updates text id when editing text id", async () => {
    ...
    expect(updateTextId).toBeCalledWith(org, app, [
...
const render = async (queries: Partial<ServicesContextProps> = {}) => {
  ...
  await waitForElementToBeRemoved(() =>
    screen.queryByText(textMock("general.loading"))
  );
