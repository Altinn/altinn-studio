    ...
    <StudioTable zebra data-color='brand1'>
      <StudioTable.Head>
        <StudioTable.Row>
          ...
          <StudioTable.Cell>{t('Url')}</StudioTable.Cell>
          <StudioTable.Cell>{t('Result code')}</StudioTable.Cell>
        </StudioTable.Row>
      </StudioTable.Head>
      <StudioTable.Body>
        {errors.map((error) => (
          <StudioTable.Row key={error.timeGenerated + error.url + error.resultCode}>
            <StudioTable.Cell>{formatDateAndTime(error.timeGenerated)}</StudioTable.Cell>
            <StudioTable.Cell>{error.url}</StudioTable.Cell>
            <StudioTable.Cell>{error.resultCode}</StudioTable.Cell>
          </StudioTable.Row>
        ))}
      </StudioTable.Body>
    </StudioTable>
