...
export const AppPreviewSubMenu = ({ viewSize, setViewSize, selectedLayoutSet, handleChangeLayoutSet }: AppPreviewSubMenuProps) => {
  return (
    <>
      <div className={classes.leftContent}>
        <SubPreviewMenuLeftContent viewSize={viewSize} setViewSize={setViewSize} selectedLayoutSet={selectedLayoutSet} handleChangeLayoutSet={handleChangeLayoutSet}/>
      </div>
      {!_useIsProdHack() &&
