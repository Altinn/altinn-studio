...
export const PolicyEditor = ({
  ...
  const [requiredAuthLevel, setRequiredAuthLevel] =
    useState<RequiredAuthLevelType>(policy.requiredAuthenticationLevelEndUser);
