...
export const MigrationPage = ({
  ...
  const { data: validatePolicyData, isLoading: validatePolicyLoading } =
        ...
        <div className={classes.contentWrapper}>
          <div className={classes.introWrapper}>
            <Paragraph size="small">
              Denne ressursen er basert på en Altinn 2 lenketjeneste. På denne
              siden får du oversikt over status på migrering av denne
              lenketjenesten fra Altinn 2.{" "}
            </Paragraph>
            <Link
              ...
              target="_blank"
            >
              Les mer i vår dokumentasjon om ressursregisteret og migrering av
              ressurser.
            </Link>
          </div>
          <MigrationStep
          ...
          <Paragraph size="small">
            Velg et miljø fra listen under du vil migrere til. Vi anbefaler å
            teste en migrering til test-miljøet før du gjennomfører en full
            migrering til produksjonsmiljøet.
          </Paragraph>
          ...
          {selectedEnv !== "" && (
            <>
              ...
              <Paragraph size="small">
                Velg dato og tid der tjenesten skal flytte delegeringene, og
                fullføre migreringen fra Altinn 2 til Altinn 3. Vi anbefaler at
                dette gjøres på et tidspunkt der tjenesten har lite eller ingen
                trafikk. For eksempel midt på natten.
              </Paragraph>
              ...
              <Paragraph size="small">
                For at brukere med eksisterende tilganger til tjenesten i Altinn
                2 skal videreføre sine tilganger for ny tjeneste migrert til
                Altinn 2 må delegeringene migreres til Altinn 3. Les detaljer om
                prosessen i vår dokumentasjon.
              </Paragraph>
