...
export const DeployResourcePage = ({
  ...
  const [hasPolicyError, setHasPolicyError] = useState<
    "none" | "validationFailed" | "notExisting"
  >("none");
  ...
  useEffect(() => {
    if (!validatePolicyLoading) {
      ...
      else if (validatePolicyData.status === 400)
        setHasPolicyError("validationFailed");
   ...
   */
  const isDeployPossible = (
    type: "test" | "prod",
    envVersion: string,
  ): boolean => {
    const policyError =
      validatePolicyData === undefined || validatePolicyData.status === 400;
        ...
        <>
          ...
          <div className={classes.contentWrapper}>
            ...
            <Paragraph size="small" className={classes.informationText}>
              ...
              og andre nettsteder som lister ressurser i Altinn. Sluttbrukere
              kan da starte delegere rettigheter til ressursen. Man bør
              verifisere i testmiljø først at tekster og metadata blir
              presentert som tenkt før man publiserer til produksjon.
            </Paragraph>
            <div className={classes.newVersionWrapper}>
              ...
              <Paragraph size="small" className={classes.newVersionParagraph}>
                En ressurs trenger å ha et versjonsnummer før den blir
                publisert. Ved endringer må versjonsnummer oppdateres før ny
                publisering.
              </Paragraph>
              <div className={classes.textAndButton}>
                ...
                <ScreenReaderSpan
                  id="versionnumber-field"
                  label="Nytt versjonssnummer"
                />
                <Button
                  color="primary"
                  onClick={() => {
