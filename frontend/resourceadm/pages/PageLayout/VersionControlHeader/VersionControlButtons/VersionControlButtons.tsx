...
import { useRepoPushMutation, useCreateRepoCommitMutation } from 'resourceadm/hooks/mutations';
...
export const VersionControlButtons = (props: IVersionControlHeaderProps) => {
  ...
  const { refetch: fetchPullData } = useRepoPullQuery(selectedContext, repo);
  ...
  const repoPushMutation = useRepoPushMutation(selectedContext, repo);
