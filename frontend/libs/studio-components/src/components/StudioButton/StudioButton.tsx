import React, { forwardRef, type ElementType, type ReactElement, type ReactNode } from 'react';
...
function StudioButtonImpl<As extends ElementType = 'button'>(
  {
    as,
    fullWidth,
    icon,
...
const StudioButton = forwardRef(StudioButtonImpl) as <As extends ElementType = 'button'>(
