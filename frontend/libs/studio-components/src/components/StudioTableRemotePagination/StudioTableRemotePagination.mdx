...
<Paragraph>
  ...
  components.
  This component is useful when data is retrieved in chunks, and the pagination logic is managed externally.
</Paragraph>

<Heading level={2} size='xxsmall'>
    Optional props:
  </Heading>
<StudioTableRemotePagination columns={propInfoColumns} rows={propInfoRowsRemotePagination} size="small"/>
<br />
