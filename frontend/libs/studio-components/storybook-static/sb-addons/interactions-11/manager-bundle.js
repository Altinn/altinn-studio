try {
  (() => {
    ...
    var Vg = __STORYBOOK_CLIENT_LOGGER__,
      { deprecate: rt, logger: Se, once: pt, pretty: Gg } = __STORYBOOK_CLIENT_LOGGER__;
    var Qg = __STORYBOOK_CORE_EVENTS__,
      {
        ARGTYPES_INFO_REQUEST: ra,
        ...
        GLOBALS_UPDATED: aa,
        NAVIGATE_URL: ab,
        PLAY_FUNCTION_THREW_EXCEPTION: Cr,
        PRELOAD_ENTRIES: ia,
        ...
        STORY_ARGS_UPDATED: la,
        STORY_CHANGED: ca,
        STORY_ERRORED: pa,
        STORY_INDEX_INVALIDATED: fa,
        STORY_MISSING: hn,
        STORY_PREPARED: da,
        STORY_RENDERED: Qt,
        STORY_RENDER_PHASE_CHANGED: nt,
        STORY_SPECIFIED: ha,
        STORY_THREW_EXCEPTION: _r,
        STORY_UNCHANGED: ma,
        TELEMETRY_ERROR: Sb,
        TOGGLE_WHATS_NEW_NOTIFICATIONS: Ab,
        UNHANDLED_ERRORS_WHILE_PLAYING: Ir,
        UPDATE_GLOBALS: Rr,
        UPDATE_QUERY_PARAMS: ya,
...
`)),
    ...
    xe(mn, 'parseErrorCode');
    var ga = class ba extends Error {
      category;
      code;
      data = {};
      documentation;
...
`
    ...
    xe(va, 'MissingStoryAfterHmrError');
    var Ea = va,
      $u = class extends Ie {
        constructor(e) {
          super({
...
`
    ...
    xe(Sa, 'CalledExtractOnStoreError');
    var Aa = Sa,
      wa = class extends Ie {
        constructor() {
          super({
    ...
    xe(wa, 'MissingRenderToCanvasError');
    var xa = wa,
      Ca = class extends Ie {
        constructor(e) {
          super({
    ...
    xe(Ca, 'CalledPreviewMethodBeforeInitializationError');
    var Ne = Ca,
      Oa = class extends Ie {
        constructor(e) {
          super({
    ...
    xe(Ia, 'MdxFileWithNoCsfReferencesError');
    var Ra = Ia,
      Ta = class extends Ie {
        constructor() {
          super({
    ...
    xe(ja, 'MissingStoryFromCsfFileError');
    var Ba = ja,
      ka = class extends Ie {
        constructor() {
          super({
    ...
    xe(ka, 'StoryStoreAccessedBeforeInitializationError');
    var Na = ka,
      Ma = class extends Ie {
        constructor(e) {
          super({
    ...
    xe(Ma, 'MountMustBeDestructuredError');
    var Dr = Ma,
      zu = class extends Ie {
        constructor() {
          super({
      ...
      Xu = (t, e, r, n) => {
        if ((e && typeof e == 'object') || typeof e == 'function')
          for (let o of Gu(e))
            !Ku.call(t, o) &&
              o !== r &&
              Va(t, o, { get: () => e[o], enumerable: !(n = Vu(e, o)) || n.enumerable });
        return t;
      },
      Qu = (t, e, r) => (
        (r = t != null ? Wu(Yu(t)) : {}),
        Xu(e || !t || !t.__esModule ? Va(r, 'default', { value: t, enumerable: !0 }) : r, t)
      ),
      Zu = Ju((t) => {
    ...
    var Ua = Qu(Zu()),
      Ga = (t) => t.map((e) => typeof e < 'u').filter(Boolean).length,
      tl = (t, e) => {
        ...
        if (typeof n < 'u') return (0, Ua.isEqual)(e, n);
        if (typeof o < 'u') return !(0, Ua.isEqual)(e, o);
        if (typeof r < 'u') {
          let i = typeof e < 'u';
          return r ? i : !i;
        }
      ...
      Ka = (t, e) => `${Ha(t, 'kind')}${e ? `--${Ha(e, 'name')}` : ''}`,
      Ja = (t) => el(t);
    function Wa(t, e) {
      return Array.isArray(e) ? e.includes(t) : t.match(e);
    }
    function Fr(t, { includeStories: e, excludeStories: r }) {
      return t !== '__esModule' && (!e || Wa(t, e)) && (!r || !Wa(t, r));
    }
    var Xa = (...t) => {
      let e = t.reduce(
    ...
    var rl = Object.create,
      ...
      c = (t, e) => Nn(t, 'name', { value: e, configurable: !0 }),
      Pr = ((t) =>
        typeof ke < 'u'
          ? ke
          : typeof Proxy < 'u'
      ...
      sl = (t, e, r, n) => {
        if ((e && typeof e == 'object') || typeof e == 'function')
          for (let o of ol(e))
            !il.call(t, o) &&
              o !== r &&
              Nn(t, o, { get: () => e[o], enumerable: !(n = nl(e, o)) || n.enumerable });
        return t;
      },
      je = (t, e, r) => (
        (r = t != null ? rl(al(t)) : {}),
        sl(e || !t || !t.__esModule ? Nn(r, 'default', { value: t, enumerable: !0 }) : r, t)
      ),
      hi = R((t, e) => {
        (function (r) {
          ...
          return c(function a(i, s, u) {
            ...
            c(l, 's');
            for (var f = typeof Pr == 'function' && Pr, d = 0; d < u.length; d++) l(u[d]);
            return l;
          }, 'e')(
            {
              1: [
      ...
      up = R((t, e) => {
        ...
        e.exports = c(function P(N, pe, S, O) {
          ...
          function me(jt, vr, ku) {
            if ((vr && ((O = q.call(O)), O.push(vr)), ku)) {
              var Lo = { depth: k.depth };
              return ee(k, 'quoteStyle') && (Lo.quoteStyle = k.quoteStyle), P(jt, Lo, S + 1, O);
            }
            return P(jt, k, S + 1, O);
          }
          ...
          if (It(N)) {
            ...
            return (
              a &&
                a.call(N, function (jt, vr) {
                  br.push(me(vr, N, !0) + ' => ' + me(jt, N));
                }),
              lt('Map', o.call(N), br, we)
            );
          }
          if (Wt(N)) {
            var Kt = [];
            return (
              ...
              lt('Set', u.call(N), Kt, we)
            );
          }
          if (mr(N)) return tt('WeakMap');
          if (yr(N)) return tt('WeakSet');
          ...
          if (!ce(N) && !ve(N)) {
            var Jt = Ye(N, me),
              ...
              Mo =
                !Pt && H && Object(N) === N && H in N ? w.call(ae(N), 8, -1) : nn ? 'Object' : '',
              Bu =
                Pt || typeof N.constructor != 'function'
                  ...
                  : N.constructor.name
                    ? N.constructor.name + ' '
                    : '',
              on = Bu + (Mo || nn ? '[' + z.call(j.call([], Mo || [], nn || []), ': ') + '] ' : '');
            return Jt.length === 0
              ? on + '{}'
              : we
                ? on + '{' + Tt(Jt, we) + '}'
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    function Gi() {
      return Re[gn] || (Re[gn] = new gp()), Re[gn];
    }
    c(Gi, 'getAddonsStore');
    var ht = Gi(),
      Yi = class {
        ...
        addRenderListeners() {
          this.removeRenderListeners(), ht.getChannel().on(Qt, this.renderListener);
        }
        removeRenderListeners() {
          ht.getChannel().removeListener(Qt, this.renderListener);
        }
      };
    c(Yi, 'HooksContext');
    var Ki = Yi;
        ...
        (t) => (e, r) => {
          ...
          return (o) => {
            ...
            for (bn = 1; a.hasUpdates; )
              if (((a.hasUpdates = !1), (a.currentEffects = []), (i = n(o)), (bn += 1), bn > bp))
                throw new Error(
    ...
    c(to, 'getHooksContextOrNull');
    function Vr() {
      let t = to();
      if (t == null) throw eo();
      return t;
    }
    c(Vr, 'getHooksContextOrThrow');
    function Ji(t, e, r) {
      let n = Vr();
...
Incoming: ${r}`),
    ...
    c(Xi, 'triggerUpdate');
    function no(t, e) {
      let r = ro(t, typeof e == 'function' ? e() : e),
        n = c((o) => {
          (r.current = typeof o == 'function' ? o(r.current) : o), Xi();
        }, 'setState');
      return [r.current, n];
    }
    c(no, 'useStateLike');
    function wp(t) {
      return no('useState', t);
    }
    c(wp, 'useState');
    function xp(t, e, r) {
      let n = r != null ? () => r(e) : e,
    ...
    c(Cp, 'useChannel');
    function Gr() {
      let { currentContext: t } = Vr();
      if (t == null) throw eo();
      return t;
    }
    c(Gr, 'useStoryContext');
    function Op(t, e) {
      let { parameters: r } = Gr();
      if (t) return r[t] ?? e;
    }
    ...
    function _p() {
      let t = ht.getChannel(),
        { id: e, args: r } = Gr(),
        n = tr((a) => t.emit(Tr, { storyId: e, updatedArgs: a }), [t, e]),
        o = tr((a) => t.emit(Or, { storyId: e, argNames: a }), [t, e]);
      return [r, n, o];
    }
    c(_p, 'useArgs');
    function Ip() {
    ...
    function Nt(t, e) {
      ...
      if (t && e && (r = t.constructor) === e.constructor) {
        ...
        if (r === Set) {
          ...
          for (n of t)
            if (((o = n), (o && typeof o == 'object' && ((o = Cn(e, o)), !o)) || !e.has(o)))
              return !1;
          return !0;
        }
        if (r === Map) {
          ...
          for (n of t)
            if (
              ((o = n[0]),
              (o && typeof o == 'object' && ((o = Cn(e, o)), !o)) || !Nt(n[1], e.get(o)))
            )
              return !1;
          return !0;
        }
        ...
        if (!r || typeof t == 'object') {
          n = 0;
          for (r in t)
            if ((ti.call(t, r) && ++n && !ti.call(e, r)) || !(r in e) || !Nt(t[r], e[r])) return !1;
...
`)),
    ...
    var Bt = Symbol('incompatible'),
      ...
      `),
            ...
            return pt.warn(`Received illegal value for '${l}'. Supported options: ${f}`), r;
          }, {}),
        'validateOptions',
      ),
      ...
      Nr = c((t, e) => {
        ...
        return (0, kr.default)(t) && (0, kr.default)(e)
          ? Object.keys({ ...t, ...e }).reduce((r, n) => {
              let o = Nr(t?.[n], e?.[n]);
    ...
    var ns = class {
      ...
      setInitial(e) {
        if (!this.initialArgsByStoryId[e.id])
          ...
          let r = Nr(this.initialArgsByStoryId[e.id], this.argsByStoryId[e.id]);
          (this.initialArgsByStoryId[e.id] = e.initialArgs),
            (this.argsByStoryId[e.id] = e.initialArgs),
      ...
      update(e, r) {
        if (!(e in this.argsByStoryId))
          throw new Error(`No args known for ${e} -- has it been rendered yet?`);
        this.argsByStoryId[e] = rs({ ...this.argsByStoryId[e], ...r });
      }
    };
    c(ns, 'ArgsStore');
    var Bp = ns,
    ...
    var kp = as,
      ...
      Mr = c((t) => (0, Np.default)(t, $p), 'normalizeInputTypes'),
...
`;
    ...
    c(ao, 'normalizeComponentAnnotations');
    var qp = c((t) => {
    ...
    function is(t, e, r) {
      ...
      return (
        Object.keys(a).forEach((u) => {
          if (Fr(u, i)) {
            let l = oo(u, a[u], i);
            ri(l.parameters), (s.stories[l.id] = l);
          }
        }),
        s
      );
        ...
        return (
          Object.keys(e).forEach((o) => {
            let a = r
              ...
              .map((i) => i[o])
              .filter((i) => typeof i < 'u');
            a.every((i) => (0, En.default)(i)) ? (n[o] = wt(...a)) : (n[o] = a[a.length - 1]);
          }),
          n
        );
      }, 'combineParameters');
    ...
    c(us, 'sanitizeStoryContextUpdate');
    function ls(t, e) {
      let r = {},
        n = c(
          (a) => (i) => {
            if (!r.value) throw new Error('Decorated function called without init');
            return (r.value = { ...r.value, ...us(i) }), a(r.value);
          },
          'bindWithContext',
        ),
        o = e.reduce((a, i) => ss(a, i, n), t);
      return (a) => ((r.value = a), o(a));
    }
    c(ls, 'defaultDecorateStory');
    function cs(t) {
      return t != null && ps(t).includes('mount');
    }
    c(cs, 'mountDestructured');
    function ps(t) {
      ...
      return n.startsWith('{') && n.endsWith('}')
        ? In(n.slice(1, -1).replace(/\s/g, '')).map((o) => o.replace(/:.*|=.*/g, ''))
        : [];
    }
    c(ps, 'getUsedProps');
    function In(t) {
    ...
    function io(t, e, r) {
      let { moduleExport: n, id: o, name: a } = t || {},
        ...
        { applyDecorators: f = ls, runStep: d } = r,
    ...
    c(io, 'prepareStory');
    function fs(t, e, r) {
      return { ...so(void 0, t, e), moduleExport: r };
    }
    c(fs, 'prepareMeta');
    function so(t, e, r) {
      let n = ['dev', 'test'],
        o = Re.DOCS_OPTIONS?.autodocs === !0 ? ['autodocs'] : [],
        a = Xa(...n, ...o, ...(r.tags ?? []), ...(e.tags ?? []), ...(t?.tags ?? [])),
    ...
    c(so, 'preparePartialAnnotations');
    function uo(t) {
      let { args: e } = t,
        r = { ...t, allArgs: void 0, argsByTarget: void 0 };
      if (Re.FEATURES?.argTypeTargetsV7) {
        let a = ts(t);
        r = { ...t, allArgs: t.args, argsByTarget: a, args: a[es] || {} };
      }
      let n = Object.entries(r.args).reduce((a, [i, s]) => {
        ...
        o = Object.entries(n).reduce((a, [i, s]) => {
          let u = r.argTypes[i] || {};
          return Ya(u, n, r.globals) && (a[i] = s), a;
        }, {});
            ...
            : (r.add(t),
              Array.isArray(t)
                ? {
                    name: 'array',
                    value:
                      t.length > 0 ? Tn(t[0], e, new Set(r)) : { name: 'other', value: 'unknown' },
                  }
                : { name: 'object', value: (0, Rn.default)(t, (o) => Tn(o, e, new Set(r))) })
          : { name: 'object', value: {} };
      }, 'inferType'),
      ds = c((t) => {
        let { id: e, argTypes: r = {}, initialArgs: n = {} } = t,
          o = (0, Rn.default)(n, (i, s) => ({ name: s, type: Tn(i, `${e}.${s}`, new Set()) })),
          a = (0, Rn.default)(r, (i, s) => ({ name: s }));
        return wt(o, a, r);
      }, 'inferArgTypes');
    ds.secondPass = !0;
    var Hp = je(Wr(), 1),
      Wp = je(Wc(), 1),
      ni = c((t, e) => (Array.isArray(e) ? e.includes(t) : t.match(e)), 'matches'),
      Vp = c(
        (t, e, r) =>
          !e && !r
            ? t
    ...
    `),
        {
          ...
          loaders: Oe(o),
          beforeEach: Oe(a),
          argTypesEnhancers: [...(r || []), ds, hs],
          initialGlobals: wt(s, i),
          ...u,
        }
      );
    }
    c(Lr, 'normalizeProjectAnnotations');
    function ms(t) {
      return async (e, r, n) => {
        await t.reduceRight(
          (o, a) => async () => a(e, o, n),
    ...
    function lo(t) {
      let e = ft(t, 'argTypesEnhancers'),
        r = Mt(t, 'runStep'),
        n = ft(t, 'beforeAll');
      return {
        parameters: wt(...Mt(t, 'parameters')),
        decorators: ft(t, 'decorators', {
          reverseFileOrder: !(Re.FEATURES?.legacyDecoratorFileOrder ?? !1),
        }),
        args: kt(t, 'args'),
        argsEnhancers: ft(t, 'argsEnhancers'),
        ...
        loaders: ft(t, 'loaders'),
        beforeAll: Yp(n),
        beforeEach: ft(t, 'beforeEach'),
        render: St(t, 'render'),
    ...
    c(ys, 'extractAnnotation');
    function Xp(t) {
      let e = Array.isArray(t) ? t : [t];
      return (Dn = lo(e.map(ys))), Dn;
    }
    ...
    function Qp(t, e, r, n, o) {
      ...
      let a = ao(e),
        ...
        h = c((b) => {
          let m = d();
          return Object.assign(m, b), gs(l, m);
        }, 'run'),
      ...
      return Object.assign(
        ...
        }, 'storyFn'),
        {
          ...
          storyName: i,
          load: c(async () => {
            for (let m of [...dt].reverse()) await m();
            dt.length = 0;
            let b = d();
            (b.loaded = await l.applyLoaders(b)),
              dt.push(...(await l.applyBeforeEach(b)).filter(Boolean)),
              (p = b);
          }, 'load'),
          args: l.initialArgs,
    ...
    function Zp(t, e, r) {
      ...
      return Object.entries(i).reduce(
        (s, [u, l]) => (Fr(u, n) ? Object.assign(s, { [u]: r(l, n, e, u) }) : s),
        {},
      );
    }
    c(Zp, 'composeStories');
    ...
    async function gs(t, e) {
      for (let o of [...dt].reverse()) await o();
      if (((dt.length = 0), !e.canvasElement)) {
      ...
      dt.push(...(await t.applyBeforeEach(e)).filter(Boolean));
      ...
      n || (await e.mount()),
        !e.abortSignal.aborted &&
          ...
          (n ||
            (e.mount = async () => {
              throw new Dr({ playFunction: r.toString() });
            }),
          await r(e));
    }
    c(gs, 'runStory');
    var oi = 1e3,
      ...
      bs = class {
        constructor(e, r, n) {
          (this.importFn = r), (this.storyIndex = new Fp(e)), (this.projectAnnotations = Lr(n));
          let { initialGlobals: o, globalTypes: a } = this.projectAnnotations;
          (this.args = new Bp()),
            (this.globals = new kp({ globals: o, globalTypes: a })),
            (this.hooks = {}),
            (this.cleanupCallbacks = {}),
            (this.processCSFFileWithCache = (0, vn.default)(oi)(is)),
            (this.prepareMetaWithCache = (0, vn.default)(oi)(fs)),
            (this.prepareStoryWithCache = (0, vn.default)(tf)(io));
        }
        storyIndex;
        projectAnnotations;
        globals;
        ...
        storyFromCSFFile({ storyId: e, csfFile: r }) {
          let n = r.stories[e];
          if (!n) throw new Ba({ storyId: e });
          let o = r.meta,
            a = this.prepareStoryWithCache(n, o, this.projectAnnotations);
          return this.args.setInitial(a), (this.hooks[a.id] = this.hooks[a.id] || new Ki()), a;
        }
        ...
        getStoriesJsonData = c(() => {
          ...
          return {
            ...
            stories: (0, Rp.default)(e.stories, (n) => {
              ...
              return {
                ...(0, ei.default)(n, ['id', 'name', 'title']),
                importPath: o,
                kind: n.title,
                story: n.name,
                parameters: { ...(0, ei.default)(n.parameters, r), fileName: o },
              };
            }),
          };
        }, 'getStoriesJsonData');
        ...
        (t = {}) =>
          (e, r) => {
            ...
            let n = t.method || 'configure',
              o = t.order || [],
              a = e.title.trim().split(ai),
              i = r.title.trim().split(ai);
  ...
  `);
      ...
      Yr = new Error('prepareAborted'),
      { AbortController: ii } = globalThis;
    function Pn(t) {
      try {
    ...
    var Es = class {
      ...
      async prepare() {
        if (
          ...
          throw (await this.store.cleanupStory(this.story), Yr);
      }
      isEqual(e) {
      ...
      async render({ initial: e = !1, forceRemount: r = !1 } = {}) {
        ...
        r && !e && (this.cancelRender(), (this.abortController = new ii()));
        ...
        try {
          ...
          if (this.renderOptions.autoplay && r && g && this.phase !== 'errored') {
            ...
            try {
              if (
                (m
                  ? await g(y)
                  : ((y.mount = async () => {
                      throw new Dr({ playFunction: g.toString() });
                    }),
            ...
            if (
              (!C && I.size > 0 && this.channel.emit(Ir, Array.from(I).map(Pn)),
    ...
    var Ss = Es,
      ...
      lf = './index.json',
      As = class {
        constructor(e, r, n = ht.getChannel(), o = !0) {
          (this.importFn = e),
        ...
        setupListeners() {
          this.channel.on(fa, this.onStoryIndexChanged.bind(this)),
            this.channel.on(Rr, this.onUpdateGlobals.bind(this)),
            this.channel.on(Tr, this.onUpdateArgs.bind(this)),
            this.channel.on(ra, this.onRequestArgTypesInfo.bind(this)),
            this.channel.on(Or, this.onResetArgs.bind(this)),
            this.channel.on(xr, this.onForceReRender.bind(this)),
            this.channel.on(Xt, this.onForceRemount.bind(this));
        }
        async getProjectAnnotationsOrRenderError() {
          try {
            let e = await this.getProjectAnnotations();
            if (((this.renderToCanvas = e.renderToCanvas), !this.renderToCanvas)) throw new xa();
            return e;
          } catch (e) {
        ...
        async getStoryIndexFromServer() {
          ...
          throw new _a({ text: await e.text() });
        }
        ...
        async onUpdateArgs({ storyId: e, updatedArgs: r }) {
          ...
          this.storyStoreValue.args.update(e, r),
            ...
            this.channel.emit(la, { storyId: e, args: this.storyStoreValue.args.get(e) });
        }
        ...
        renderPreviewEntryError(e, r) {
          (this.previewEntryError = r), Se.error(e), Se.error(r), this.channel.emit(na, r);
        }
      };
    c(As, 'Preview');
    var cf = As,
    ...
    var xs = ws,
      Cs = class {
        ...
        docsContext(e) {
          ...
          let r = new xs(this.channel, this.store, e, this.csfFiles);
        ...
        async renderToElement(e, r) {
          ...
          let a = await o.renderer(),
            ...
            s = c(async () => {
              try {
                await i(n, o, e), this.channel.emit(wr, this.id);
              } catch (u) {
    ...
    var si = Cs,
      Os = class {
        ...
        docsContext(e) {
          if (!this.csfFiles) throw new Error('Cannot render docs before preparing');
          return new xs(this.channel, this.store, e, this.csfFiles);
        }
        async renderToElement(e, r) {
          ...
          let a = { ...o, page: this.exports.default },
            ...
            u = c(async () => {
              try {
                await s(n, a, e), this.channel.emit(wr, this.id);
              } catch (l) {
    ...
    var Is = 'attached-mdx',
      df = 'unattached-mdx';
    function Rs({ tags: t }) {
      return t?.includes(df) || t?.includes(Is);
    }
    c(Rs, 'isMdxEntry');
    function Br(t) {
      return t.type === 'story';
    ...
    c(Ts, 'isDocsRender');
    function Ds(t) {
      return Ts(t) && t.subtype === 'csf';
    }
    c(Ds, 'isCsfDocsRender');
    var Fs = class extends cf {
      constructor(e, r, n, o) {
        super(e, r, void 0, !1),
          (this.importFn = e),
          (this.getProjectAnnotations = r),
      ...
      setupListeners() {
        super.setupListeners(),
          ...
          this.channel.on(ya, this.onUpdateQueryParams.bind(this)),
          this.channel.on(ia, this.onPreloadStories.bind(this));
      }
      async setInitialGlobals() {
      ...
      async selectSpecifiedStory() {
        ...
        if (!n) {
          e === '*'
            ? this.renderStoryLoadingException(e, new Da())
            : this.renderStoryLoadingException(e, new Pa({ storySpecifier: e.toString() }));
          return;
        }
        let { id: o, type: a } = n;
        this.selectionStore.setSelection({ storyId: o, viewMode: a }),
          this.channel.emit(ha, this.selectionStore.selection),
      ...
      onKeydown(e) {
        if (!this.storyRenders.find((r) => r.disableKeyListeners) && !_s(e)) {
      ...
      async onUpdateGlobals({ globals: e }) {
        super.onUpdateGlobals({ globals: e }),
          (this.currentRender instanceof ui || this.currentRender instanceof si) &&
      ...
      async renderSelection({ persistedArgs: e } = {}) {
        ...
        a.type === 'story'
          ...
          : Rs(a)
            ? (u = new ui(this.channel, this.storyStoreValue, a, this.mainStoryCallbacks(o)))
            : (u = new si(this.channel, this.storyStoreValue, a, this.mainStoryCallbacks(o)));
        ...
        try {
          ...
          f && (await this.teardownRender(f)), p !== Yr && this.renderStoryLoadingException(o, p);
          return;
        }
        let d = !i && f && !u.isEqual(f);
        if (
          (e && Br(u) && (jr(!!u.story), this.storyStoreValue.args.updateFromPersisted(u.story, e)),
          f && !f.torndown && !i && !d && !s)
        ) {
          (this.currentRender = f), this.channel.emit(ma, o), this.view.showMain();
          return;
        }
        if (
          (f && (await this.teardownRender(f, { viewModeChanged: s })),
          l && (i || s) && this.channel.emit(ca, o),
          Br(u))
        ) {
          jr(!!u.story);
          let {
          ...
          this.channel.emit(da, { id: o, parameters: p, initialArgs: g, argTypes: h, args: v });
        } else {
          let { parameters: p } = this.storyStoreValue.projectAnnotations;
          if (Ds(u) || u.entry.tags?.includes(Is)) {
            if (!u.csfFiles) throw new Ra({ storyId: o });
            ({ parameters: p } = this.storyStoreValue.preparedMetaFromCSFFile({
              csfFile: u.csfFiles[0],
            }));
          }
          this.channel.emit(oa, { id: o, parameters: p });
        }
        Br(u)
          ? (jr(!!u.story),
      ...
      renderException(e, r) {
        ...
        this.channel.emit(_r, { name: n, message: o, stack: a }),
      ...
      renderError(e, { title: r, description: n }) {
        Se.error(`Error rendering story ${r}: ${n}`),
          this.channel.emit(pa, { title: r, description: n }),
          this.channel.emit(nt, { newPhase: 'errored', storyId: e }),
          this.view.showErrorDisplay({ message: r, stack: n });
      }
    };
    c(Fs, 'PreviewWithSelection');
    var hf = Fs,
      jn = je(Zn(), 1),
      mf = je(Zn(), 1),
      yf = je(Kn(), 1),
        ...
        (t = '', e) =>
          t === null || t === '' || !li.test(t)
            ...
            : e == null || e instanceof Date || typeof e == 'number' || typeof e == 'boolean'
              ? !0
              : typeof e == 'string'
                ? li.test(e) || Ps.test(e) || gf.test(e) || js.test(e)
                : Array.isArray(e)
                  ? e.every((r) => Bn(t, r))
                  : (0, yf.default)(e)
                    ? Object.entries(e).every(([r, n]) => Bn(r, n))
                    : !1,
        'validateArgs',
      ),
      bf = {
        ...
        decoder(t, e, r, n) {
          ...
          return n === 'value' && Ps.test(t) ? Number(t) : e(t, e, r);
        },
      },
      ci = c((t) => {
    ...
    c(ks, 'pathToId');
    var Ns = c(({ selection: t, extraParams: e }) => {
        let r = typeof ot < 'u' ? ot.location.search : '',
          {
            ...
            selectedStory: a,
            ...i
          } = jn.default.parse(r, { ignoreQueryPrefix: !0 });
        return jn.default.stringify(
      ...
      vf = c((t) => {
        if (!t) return;
        let e = Ns({ selection: t }),
          { hash: r = '' } = ot.location;
        (ot.title = t.storyId), Bs.replaceState({}, '', `${ot.location.pathname}${e}${r}`);
      }, 'setPath'),
      ...
      Sf = c(() => {
        if (typeof ot < 'u') {
          let t = jn.default.parse(ot.location.search, { ignoreQueryPrefix: !0 }),
            e = typeof t.args == 'string' ? ci(t.args) : void 0,
            r = typeof t.globals == 'string' ? ci(t.globals) : void 0,
            n = er(t.viewMode);
      ...
      Ms = class {
        ...
        setQueryParams(e) {
          let r = Ns({ extraParams: e }),
            { hash: n = '' } = ot.location;
          Bs.replaceState({}, '', `${ot.location.pathname}${r}${n}`);
        }
      };
    c(Ms, 'UrlStore');
    var Af = Ms,
        ...
        showMode(e) {
          clearTimeout(this.preparingTimeout),
            Object.keys(Ls).forEach((r) => {
              r === e ? De.body.classList.add(An[r]) : De.body.classList.remove(An[r]);
            });
        }
...
`,
              ...
              .replace(/^\n/, ''))),
            (De.getElementById('error-message').innerHTML = fi.toHtml(n)),
            (De.getElementById('error-stack').innerHTML = fi.toHtml(o)),
            this.showMode('ERROR');
        }
        showNoPreview() {
          this.testing ||
        ...
        showPreparingStory({ immediate: e = !1 } = {}) {
          clearTimeout(this.preparingTimeout),
            e
              ...
              : (this.preparingTimeout = setTimeout(() => this.showMode('PREPARING_STORY'), pi));
        }
        showPreparingDocs({ immediate: e = !1 } = {}) {
          clearTimeout(this.preparingTimeout),
            e
              ? this.showMode('PREPARING_DOCS')
              : (this.preparingTimeout = setTimeout(() => this.showMode('PREPARING_DOCS'), pi));
        }
        showMain() {
          this.showMode('MAIN');
        }
    ...
    function co(t, e, r = 0) {
      t[r](() => {
        r++, r === t.length ? e() : co(t, e, r);
      });
    }
    c(co, 'insertScriptsSequentially');
    function Rf(t) {
      let e = At.getElementById(di);
      e ? (e.innerHTML = '') : ((e = At.createElement('div')), (e.id = di), At.body.appendChild(e));
      let r = Array.from(t.querySelectorAll(If));
      if (r.length) {
        let n = [];
        r.forEach((o) => {
          let a = o.getAttribute('type');
          (!a || _f.includes(a)) && n.push((i) => zs(o, i, e));
        }),
          n.length && co(n, kn, void 0);
      } else kn();
    }
      ...
      kf = (t, e, r, n) => {
        if ((e && typeof e == 'object') || typeof e == 'function')
          for (let o of Us(e))
            !jf.call(t, o) &&
              o !== r &&
              qs(t, o, { get: () => e[o], enumerable: !(n = Ff(e, o)) || n.enumerable });
        return t;
      },
      Ct = (t, e, r) => (
        (r = t != null ? Df(Pf(t)) : {}),
        kf(e || !t || !t.__esModule ? qs(r, 'default', { value: t, enumerable: !0 }) : r, t)
      ),
      Nf = Be({
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
            ...
            function b(S, O, k) {
              ...
              for (var Z = O.truncate, ie = '', he = '', we = '', me = 0; me < X; me += 1) {
                var Pe = me + 1 === S.length,
                  Ke = me + 2 === S.length;
                we = ''.concat(p, '(').concat(S.length - me, ')');
                var Dt = S[me];
                O.truncate = Z - ie.length - (Pe ? 0 : Y.length);
                var He = he || k(Dt, O) + (Pe ? '' : Y),
                  Je = ie.length + He.length,
                  Xe = Je + we.length;
                if (
                  (Pe && Je > Z && ie.length + we.length <= Z) ||
                  (!Pe && !Ke && Xe > Z) ||
                  ((he = Pe ? '' : k(S[me + 1], O) + (Ke ? '' : Y)),
                  !Pe && Ke && Xe > Z && Je + he.length > Z)
                )
                  break;
                if (((ie += He), !Pe && !Ke && Je + he.length >= Z)) {
...
`,
            ...
            var yr = typeof Symbol == 'function' && typeof Symbol.for == 'function',
              vt = yr ? Symbol.for('chai/inspect') : '@@chai/inspect',
              Ge = !1;
            try {
              var Vt = Bf('util');
    ...
    ho.open = '';
    ho.close = '';
    var R0 = Kf.reduce((t, [e]) => ((t[e] = ho), t), { isColorSupported: !1 });
    var {
    ...
    function bo(t, e, r) {
      ...
      return r && ut(o, r.prototype), o;
    }
    function cr(t) {
      var e = typeof Map == 'function' ? new Map() : void 0;
      return (
        (cr = function (n) {
          if (n === null || !go(n)) return n;
          ...
          function o() {
            return bo(n, arguments, lr(this).constructor);
          }
          return (
    ...
    function cd(t, e, r) {
      return Ao('#' + So(t) + So(e) + So(r));
    }
    function Xr(t, e, r) {
      return pr(t, e, r, cd);
    }
    function pd(t, e, r) {
      if (typeof t == 'number' && typeof e == 'number' && typeof r == 'number') return Xr(t, e, r);
    ...
    function fd(t, e, r, n) {
      if (
        ...
        return n >= 1 ? Xr(t, e, r) : 'rgba(' + pr(t, e, r) + ',' + n + ')';
      if (typeof t == 'object' && e === void 0 && r === void 0 && n === void 0)
        return t.alpha >= 1
          ? Xr(t.hue, t.saturation, t.lightness)
          : 'rgba(' + pr(t.hue, t.saturation, t.lightness) + ',' + t.alpha + ')';
      throw new Me(2);
    }
    function wo(t, e, r) {
      if (typeof t == 'number' && typeof e == 'number' && typeof r == 'number')
        return Ao('#' + Ot(t) + Ot(e) + Ot(r));
      if (typeof t == 'object' && e === void 0 && r === void 0)
        return Ao('#' + Ot(t.red) + Ot(t.green) + Ot(t.blue));
      throw new Me(6);
    }
    function Qr(t, e, r, n) {
      if (typeof t == 'string' && typeof e == 'number') {
        ...
        if (
          ...
          return n >= 1 ? wo(t, e, r) : 'rgba(' + t + ',' + e + ',' + r + ',' + n + ')';
        if (typeof t == 'object' && e === void 0 && r === void 0 && n === void 0)
          return t.alpha >= 1
            ? wo(t.red, t.green, t.blue)
    ...
    function gd(t, e) {
      ...
      var r = yt(e);
      return gt(Fe({}, r, { hue: r.hue + parseFloat(t) }));
    }
    var xv = ze(gd);
    function Ut(t, e, r) {
    ...
    function bd(t, e) {
      if (e === 'transparent') return e;
      var r = yt(e);
      return gt(Fe({}, r, { lightness: Ut(0, 1, r.lightness - parseFloat(t)) }));
    }
    var Cv = ze(bd);
    function vd(t, e) {
      if (e === 'transparent') return e;
      var r = yt(e);
      return gt(Fe({}, r, { saturation: Ut(0, 1, r.saturation - parseFloat(t)) }));
    }
    var Ov = ze(vd);
    function Ed(t, e) {
      if (e === 'transparent') return e;
    ...
    function Sd(t, e, r) {
      ...
      var n = qt(e),
        ...
        a = qt(r),
        i = Fe({}, a, { alpha: typeof a.alpha == 'number' ? a.alpha : 1 }),
        s = o.alpha - i.alpha,
        u = parseFloat(t) * 2 - 1,
        l = u * s === -1 ? u : u + s,
        f = 1 + u * s,
    ...
    var Rv = ze(xd);
    function Cd(t, e) {
      return e === 'transparent' ? e : gt(Fe({}, yt(e), { hue: parseFloat(t) }));
    }
    var Tv = ze(Cd);
    function Od(t, e) {
      return e === 'transparent' ? e : gt(Fe({}, yt(e), { lightness: parseFloat(t) }));
    }
    var Dv = ze(Od);
    function _d(t, e) {
      return e === 'transparent' ? e : gt(Fe({}, yt(e), { saturation: parseFloat(t) }));
    }
    var Fv = ze(_d);
    function Id(t, e) {
    ...
    var Fd = Object.create,
      ...
      fr = fe(cn)(({ theme: t }) => ({ fontFamily: t.typography.fonts.base })),
      dr = fe(un)(({ theme: t }) => ({ color: t.textMutedColor, margin: '0 3px' })),
      th = fe(Zo)({ marginTop: 0 }),
      rh = fe(Qo)(({ theme: t }) => ({
        color: t.textMutedColor,
              ...
              x.createElement(
                ...
                x.createElement(
                  Et,
                  {
                    trigger: 'hover',
                    hasChrome: !1,
                    tooltip: x.createElement(fr, { note: 'Go to start' }),
                  },
                  x.createElement(
                    nh,
                ...
                x.createElement(
                  Et,
                  {
                    trigger: 'hover',
                    hasChrome: !1,
                    tooltip: x.createElement(fr, { note: 'Go back' }),
                  },
                  x.createElement(
                    dr,
                ...
                x.createElement(
                  Et,
                  {
                    trigger: 'hover',
                    hasChrome: !1,
                    tooltip: x.createElement(fr, { note: 'Go forward' }),
                  },
                  x.createElement(
                    dr,
                ...
                x.createElement(
                  Et,
                  {
                    trigger: 'hover',
                    hasChrome: !1,
                    tooltip: x.createElement(fr, { note: 'Go to end' }),
                  },
                  x.createElement(
                    dr,
                ...
                x.createElement(
                  Et,
                  {
                    trigger: 'hover',
                    hasChrome: !1,
                    tooltip: x.createElement(fr, { note: 'Rerun' }),
                  },
                  x.createElement(
                    ah,
    ...
    function Do(t) {
      ...
      if (t)
        if (typeof t == 'object')
          if (Array.isArray(t))
            for (e = 0; e < t.length; e++) t[e] && (r = Do(t[e])) && (n && (n += ' '), (n += r));
          else for (e in t) t[e] && (r = Do(e)) && (n && (n += ' '), (n += r));
        else typeof t != 'boolean' && !t.call && (n && (n += ' '), (n += t));
      return n;
    }
    function Ze() {
      for (var t = 0, e, r = ''; t < arguments.length; )
        (e = Do(arguments[t++])) && (r && (r += ' '), (r += e));
      return r;
    }
    var Bo = (t) => Array.isArray(t) || (ArrayBuffer.isView(t) && !(t instanceof DataView)),
      xu = (t) =>
        t !== null &&
        typeof t == 'object' &&
        !Bo(t) &&
      ...
      lh = (t) => xu(t) || Bo(t) || typeof t == 'function' || t instanceof Promise,
      Cu = (t) => {
        let e = /unique/;
      ...
      ph = Ve(zd()),
      fh = ['children'],
      Fo = x.createContext({ theme: 'chrome', colorScheme: 'light' }),
      dh = (t) => {
        let { children: e } = t,
          r = (0, ph.default)(t, fh),
          n = x.useContext(Fo);
      ...
      en = (t) => {
        let {
          ...
          f = (0, hh.default)(t, yh),
          { themeClass: d, currentTheme: p } = rn({ theme: e, colorScheme: n }, Le),
          [g, h] = We(l);
        ct(() => {
          h(l);
        }, [l]);
        let v = ($) => {
          ...
          { isChild: L, depth: _, hasHover: F } = x.useContext(Co),
          B = F ? r : !1;
        if (!L)
          return x.createElement(
            'ul',
            ...
            x.createElement(
              ...
              x.createElement(en, t),
            ),
          );
        if (!b)
          return x.createElement(
            'li',
            (0, xo.default)({ role: 'treeitem', className: Le.item }, f),
            x.createElement(
              'div',
              {
                role: 'button',
        ...
        return x.createElement(
          ...
          x.createElement(
            'ul',
            (0, xo.default)({ role: 'group', className: Ze(i, Le.group) }, f),
            g &&
              x.Children.map(o, ($) =>
                x.createElement(
                  Co.Provider,
    ...
    var _u = Ou,
      ...
      Iu = (t) => {
        let { ast: e, theme: r, previewMax: n, open: o, colorScheme: a, className: i } = t,
          s = (0, Eh.default)(t, Sh),
          { themeClass: u, currentTheme: l } = rn({ theme: r, colorScheme: a }, Ae),
          f = e.isPrototype || !1,
    ...
    ko.defaultProps = { expandLevel: 0, depth: 0 };
    var Ih = ko,
      Rh = [
        'data',
        'expandLevel',
    ...
    var Th = {
      ...
      _t = ({ value: t, nested: e, showObjectInspector: r, callsById: n, ...o }) => {
        switch (!0) {
          ...
          case Object.prototype.hasOwnProperty.call(t, '__callId__'):
            return x.createElement(No, { call: n.get(t.__callId__), callsById: n });
      ...
      No = ({ call: t, callsById: e }) => {
        ...
        let r = t.path.flatMap((a, i) => {
            ...
            return [
              s
                ? x.createElement(No, { key: `elem${i}`, call: e.get(s), callsById: e })
...
`);
        return x.createElement(
          ...
          r.flatMap((n, o) => {
            if (n.startsWith('expect(')) {
              ...
              if (p) {
                ...
                if (h)
                  return [
                    'expect(',
                    x.createElement(_o, { key: `received_${f}`, value: f }),
                    n.slice(d, g),
                    x.createElement(Io, { key: `expected_${h}`, value: h }),
                    n.slice(g + h.length),
            ...
            if (n.match(/^\s*- /))
              return [
                x.createElement(Io, { key: n + o, value: n }),
                x.createElement('br', { key: `br${o}` }),
              ];
            if (n.match(/^\s*\+ /) || n.match(/^Received: $/))
              return [
                x.createElement(_o, { key: n + o, value: n }),
                x.createElement('br', { key: `br${o}` }),
              ];
            ...
            if (a && i)
              return a === 'Expected'
                ? [
                    'Expected: ',
                    x.createElement(Io, { key: n + o, value: Oo(i), parsed: !0 }),
                    x.createElement('br', { key: `br${o}` }),
                  ]
                : [
                    'Received: ',
                    x.createElement(_o, { key: n + o, value: Oo(i), parsed: !0 }),
                    x.createElement('br', { key: `br${o}` }),
                  ];
            let [, s, u] =
            ...
            return l
              ? [
                  'Received has value: ',
                  x.createElement(_t, { key: n + o, value: Oo(l) }),
                  x.createElement('br', { key: `br${o}` }),
                ]
              : [
        ...
        switch (t) {
          ...
          case de.WAITING:
            return x.createElement(
              ...
              x.createElement(Zs, { color: Zr(0.5, '#CCCCCC'), size: 6 }),
            );
          default:
            return null;
        }
    ...
    var em = fe.div(() => ({
      ...
      tm = fe('div', { shouldForwardProp: (t) => !['call', 'pausedAt'].includes(t.toString()) })(
        ({ theme: t, call: e }) => ({
          ...
          fontSize: 13,
          ...(e.status === de.ERROR && {
            backgroundColor: t.base === 'dark' ? Zr(0.93, t.color.negative) : t.background.warning,
          }),
      ...
      om = fe.div({ padding: 6 }),
      am = fe(un)(({ theme: t }) => ({ color: t.textMutedColor, margin: '0 3px' })),
...
`),
      ...
      pm = () => {
        let [t, e] = We(!0),
          r = Vo().getDocsUrl({ subpath: Kd, versioned: !0, renderer: !0 });
        return (
          ct(() => {
            let n = setTimeout(() => {
              e(!1);
        ...
        return se(
          ...
          i &&
            ...
            se(
              gu,
              null,
              se(bu, null, 'Caught exception in ', se(Ro, null, 'play'), ' function'),
          ...
          s &&
            se(
              ...
              se(
                ...
                se(Ro, null, 'test.dangerouslyIgnoreUnhandledErrors'),
                ' ',
                'parameter to ',
                se(Ro, null, 'true'),
                '.',
    ...
    var To = { start: !1, back: !1, goto: !1, next: !1, end: !1 },
      ...
      mm = Sr(function ({ storyId: t }) {
        ...
        let A = zo(
            () => ({
              start: () => y(mt.START, { storyId: t }),
              back: () => y(mt.BACK, { storyId: t }),
              goto: (E) => y(mt.GOTO, { storyId: t, callId: E }),
              next: () => y(mt.NEXT, { storyId: t }),
              end: () => y(mt.END, { storyId: t }),
              rerun: () => {
                y(Xt, { storyId: t });
              },
            }),
        ...
        return u
          ? x.createElement(Er, { key: 'interactions' })
          : x.createElement(
              Er,
              { key: 'interactions' },
              x.createElement(hm, {
    ...
    function gm() {
      ...
      return x.createElement(
        ...
        x.createElement(
          ...
          r && !e ? x.createElement(Yo, { status: 'neutral' }, r) : null,
      ...
      an.add(Gd, {
        ...
        render: ({ active: e }) => {
          ...
          return x.createElement(
            Go,
            { active: e },
            x.createElement(qo, { filter: r }, ({ storyId: n }) =>
