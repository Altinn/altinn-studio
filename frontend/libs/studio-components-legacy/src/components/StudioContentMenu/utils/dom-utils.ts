...
export function moveFocus(event: React.KeyboardEvent<HTMLTabElement>) {
...
function getNextTab({ key, currentTarget }: React.KeyboardEvent<HTMLTabElement>) {
...
function getTabElementAbove(tabs: HTMLTabElement[], currentTab: HTMLTabElement) {
...
function getTabElementBelow(tabs: HTMLTabElement[], currentTab: HTMLTabElement) {
  const currentIndex = tabs.indexOf(currentTab);
