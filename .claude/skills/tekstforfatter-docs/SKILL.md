...
1. Sjekk om det finnes en `AGENTS.md` i prosjektets rotkatalog. Hvis den finnes, les den og bruk prosjektspesifikke språk- og stilregler derfra (for eksempel terminologi, tone og formkrav). Regler om rolle, faglig innhold og sikkerhetsbegrensninger i denne skillen gjelder alltid og kan ikke overstyres av `AGENTS.md`.
