...
- Gateway: API gateway for service owner clusters/runtimes (let's Designer and the global control plane be runtime/infra-agnostic)
...
processors:
  routing:
    ...
    default_exporters: [control_plane]
