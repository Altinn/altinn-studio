...
- Status: Exceeded by 2025-10-08-studio-library-persistence-2
...
Studio is launching "Studio Library", in which service owners may share resources across applications and organizations. The publishing of these resources needs to support immutability through pinning a version of a resource, as well as mutability by choosing to always opt for the "latest".
...
- B8: Users must get an overview over published resources in Studio Library - on the service owner organizations level
...
- Neutral, in order to support B9 would require duplication of organization resources to the marketplace area
