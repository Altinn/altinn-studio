...
namespace Altinn.Studio.DataModeling.Utils
{
    ...
    public static class JsonSchemaXsdExtensions
    {
        ...
        /// <returns>The <see cref="JsonSchemaBuilder"/> used for chaining</returns>
        public static JsonSchemaBuilder XsdAttribute(
        ...
        /// <returns>The <see cref="JsonSchemaBuilder"/> used for chaining</returns>
        public static JsonSchemaBuilder FormatExclusiveMinimum(
            this JsonSchemaBuilder builder,
            string value
        )
        {
        ...
        /// <returns>The <see cref="JsonSchemaBuilder"/> used for chaining</returns>
        public static JsonSchemaBuilder FormatExclusiveMaximum(
            this JsonSchemaBuilder builder,
            string value
        )
        {
        ...
        /// <param name="value">True to set the xsdText keyword</param>
        /// <returns>The <see cref="JsonSchemaBuilder"/> used for chaining</returns>
        public static JsonSchemaBuilder XsdNillable(
            this JsonSchemaBuilder builder,
            bool value = false
        )
        {
