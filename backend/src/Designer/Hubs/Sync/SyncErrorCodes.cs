...
{
    public const string ApplicationMetadataTaskIdSyncError = nameof(
    ...
    public const string ApplicationMetadataDataTypeSyncError = nameof(
    ...
    public const string LayoutSetIdChangedLayoutsSyncError = nameof(
        LayoutSetIdChangedLayoutsSyncError
    );
    ...
    public const string LayoutPageDeletedLayoutsSyncError = nameof(
        LayoutPageDeletedLayoutsSyncError
    );
    public const string LayoutPageIdChangedLayoutsSyncError = nameof(
        LayoutPageIdChangedLayoutsSyncError
    );
}
