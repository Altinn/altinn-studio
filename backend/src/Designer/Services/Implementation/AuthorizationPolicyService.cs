...
namespace Altinn.Studio.Designer.Services.Implementation
{
    ...
    public class AuthorizationPolicyService : IAuthorizationPolicyService
    {
        ...
        )
        {
            ...
            FileSystemObject policyFile = await GetAuthorizationPolicyFileFromGitea(
                org,
                app,
                shortCommitId
            );
        ...
        private string GetAuthorizationPolicyFilePath()
        {
            ...
            string authorizationPolicyFileName =
                _serviceRepositorySettings.AuthorizationPolicyFileName;
