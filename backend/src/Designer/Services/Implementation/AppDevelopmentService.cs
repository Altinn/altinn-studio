...
namespace Altinn.Studio.Designer.Services.Implementation
{
    ...
    public class AppDevelopmentService : IAppDevelopmentService
    {
        ...
        /// <inheritdoc />
        public async Task SaveFormLayout(
            AltinnRepoEditingContext altinnRepoEditingContext,
            string layoutSetName,
            string layoutName,
            JsonNode formLayout,
        ...
        /// <inheritdoc />
        public async Task<JsonNode> GetLayoutSettings(
            AltinnRepoEditingContext altinnRepoEditingContext,
            string layoutSetName,
            CancellationToken cancellationToken = default
        )
        ...
        /// <inheritdoc />
        public async Task SaveLayoutSettings(
            AltinnRepoEditingContext altinnRepoEditingContext,
        ...
        /// <inheritdoc />
        public async Task<string[]> GetLayoutNames(
            AltinnRepoEditingContext altinnRepoEditingContext,
            CancellationToken cancellationToken = default
        )
        {
            ...
            if (appUsesLayoutSets)
            {
                ...
                {
                    string[] layoutNamesForSet = altinnAppGitRepository.GetLayoutNames(
                        layoutSetConfig.Id
                    );
        ...
        /// <inheritdoc />
        public async Task<IEnumerable<string>> GetAppMetadataModelIds(
            AltinnRepoEditingContext altinnRepoEditingContext,
        ...
        )
        {
            ...
            if (dataModelName is not null)
            {
                ...
                modelMetadata = await _schemaModelService.GenerateModelMetadataFromJsonSchema(
            ...
            string modelName = await GetModelName(
                altinnRepoEditingContext,
                layoutSetName,
                cancellationToken
            );
        ...
        )
        {
            ...
            LayoutSets layoutSets = await GetLayoutSets(
                altinnRepoEditingContext,
                cancellationToken
            );
        ...
        /// <inheritdoc />
        public async Task<LayoutSets> GetLayoutSets(
            AltinnRepoEditingContext altinnRepoEditingContext,
            CancellationToken cancellationToken = default
        )
        {
        ...
        private static string TaskTypeFromDefinitions(Definitions definitions, string taskId)
        {
            return definitions
                    ...
                    ?.ExtensionElements?.TaskExtension?.TaskType ?? string.Empty;
        }
        ...
        )
        {
            ...
            LayoutSets layoutSetsFile = await altinnAppGitRepository.GetLayoutSetsFile(
                cancellationToken
            );
        ...
        /// <inheritdoc />
        public async Task<LayoutSets> AddLayoutSet(
            AltinnRepoEditingContext altinnRepoEditingContext,
            LayoutSetConfig newLayoutSet,
            bool layoutIsInitialForPaymentTask = false,
            CancellationToken cancellationToken = default
        )
        {
            cancellationToken.ThrowIfCancellationRequested();
            ...
            if (layoutSets.Sets.Exists(set => set.Id == newLayoutSet.Id))
            {
                throw new NonUniqueLayoutSetIdException(
                    $"Layout set name, {newLayoutSet.Id}, already exists."
                );
            }
            if (
                newLayoutSet.Tasks != null
                && layoutSets.Sets.Exists(set => set.Tasks?[0] == newLayoutSet.Tasks[0])
            )
            {
            ...
            return await AddNewLayoutSet(
                altinnAppGitRepository,
                layoutSets,
                newLayoutSet,
                layoutIsInitialForPaymentTask
            );
        }

        /// <inheritdoc />
        public async Task<LayoutSets> UpdateLayoutSetName(
            AltinnRepoEditingContext altinnRepoEditingContext,
        ...
        )
        {
            ...
            {
                throw new NonUniqueLayoutSetIdException(
                    $"Layout set name, {newLayoutSetName}, already exists."
                );
            }
            ...
            return await UpdateLayoutSetName(
                altinnAppGitRepository,
                layoutSets,
                oldLayoutSetName,
                newLayoutSetName
        ...
        public async Task<LayoutSets> DeleteLayoutSet(
            AltinnRepoEditingContext altinnRepoEditingContext,
        ...
        )
        {
            ...
            {
                await DeleteTaskRefInApplicationMetadata(
                    altinnAppGitRepository,
                    dataTypeNameToRemoveTaskIdRef
                );
            }

            altinnAppGitRepository.DeleteLayoutSetFolder(layoutSetToDeleteId, cancellationToken);
            return await DeleteExistingLayoutSet(
                altinnAppGitRepository,
                layoutSets,
                layoutSetToDeleteId
            );
        ...
        )
        {
            ...
            var dataType = applicationMetadata.DataTypes.Find(dataType =>
        ...
        private static async Task<LayoutSets> DeleteExistingLayoutSet(
            AltinnAppGitRepository altinnAppGitRepository,
            LayoutSets layoutSets,
            string layoutSetToDeleteId
        )
        {
            LayoutSetConfig layoutSetToDelete = layoutSets.Sets.Find(set =>
                set.Id == layoutSetToDeleteId
            );
        ...
        private static async Task<LayoutSets> AddNewLayoutSet(
            AltinnAppGitRepository altinnAppGitRepository,
            LayoutSets layoutSets,
        ...
        )
        {
            ...
            {
                AddPaymentComponentToInitialLayoutForPaymentTask(
        ...
        private async Task<LayoutSets> UpdateLayoutSetName(
            AltinnAppGitRepository altinnAppGitRepository,
            LayoutSets layoutSets,
            string oldLayoutSetName,
            string newLayoutSetName
        ...
        /// <inheritdoc />
        public async Task SaveRuleHandler(
            AltinnRepoEditingContext altinnRepoEditingContext,
            string ruleHandler,
            string layoutSetName,
            CancellationToken cancellationToken = default
        ...
        /// <inheritdoc />
        public async Task SaveRuleConfig(
            AltinnRepoEditingContext altinnRepoEditingContext,
            JsonNode ruleConfig,
            string layoutSetName,
            CancellationToken cancellationToken = default
        )
        {
            ...
            await altinnAppGitRepository.SaveRuleConfiguration(
                layoutSetName,
                ruleConfig,
                cancellationToken
            );
        ...
        public SemanticVersion GetAppLibVersion(AltinnRepoEditingContext altinnRepoEditingContext)
        {
            ...
            throw new FileNotFoundException(
                "Unable to extract the version of the app-lib from csproj files."
            );
        }

        public bool TryGetFrontendVersion(
            AltinnRepoEditingContext altinnRepoEditingContext,
            out string version
        )
        {
            ...
            return indexFilePath is not null
                && AppFrontendVersionHelper.TryGetFrontendVersionFromIndexFile(
                    indexFilePath,
                    out version
                );
        }
        ...
        )
        {
            ...
            JsonNode formLayout = await altinnAppGitRepository.GetLayout(
                layoutSetName,
                layoutName,
                cancellationToken
            );
            if (
                formLayout["data"] is not JsonObject data
        ...
        )
        {
            ...
            var deletedReferences = referencesToUpdate
                .Where(item => string.IsNullOrEmpty(item.NewId))
                .ToList();
            var updatedReferences = referencesToUpdate
                .Where(item => !string.IsNullOrEmpty(item.NewId))
                .ToList();
            ...
            var deletedLayoutsSetIds = deletedReferences
                ...
                .Select(item => item.Id)
                .ToList();
            var deletedLayouts = deletedReferences
                .Where(item => item.Type == ReferenceType.Layout)
                .ToList();
            var deletedComponents = deletedReferences
                .Where(item => item.Type == ReferenceType.Component)
                .ToList();

            var updatedTasks = updatedReferences
                .Where(item => item.Type == ReferenceType.Task)
                .ToList();
            var updatedLayoutsSets = updatedReferences
                .Where(item => item.Type == ReferenceType.LayoutSet)
                .ToList();
            var updatedLayouts = updatedReferences
                .Where(item => item.Type == ReferenceType.Layout)
                .ToList();
            var updatedComponents = updatedReferences
                .Where(item => item.Type == ReferenceType.Component)
                .ToList();
            ...
            foreach (LayoutSetConfig layoutSet in layoutSets ?? [new() { Id = null }])
            {
                ...
                var deletedLayoutIdsFromCurrentLayoutSet = deletedLayouts
                    .Where(item =>
                        item.LayoutSetName == layoutSet.Id && string.IsNullOrEmpty(item.NewId)
                    )
                    .Select(item => item.Id)
                    .ToList();
                foreach (KeyValuePair<string, JsonNode> layout in layouts)
                {
                    bool isLayoutDeleted = deletedLayoutIdsFromCurrentLayoutSet.Contains(
                        layout.Key
                    );
                    ...
                    if (data["layout"] is JsonArray componentList)
                    {
                        for (int i = componentList.Count - 1; i >= 0; i--)
                        {
                            ...
                            bool isComponentDeleted =
                                deletedComponentIdsFromCurrentLayoutSet.Contains(componentId);
                            ...
                            else
                            {
                                Reference updatedReference =
                                    updatedComponentsFromCurrentLayoutSet.FirstOrDefault(item =>
                                        item.Id == componentId
                                    );
                            ...
                            {
                                case "Subform":
                                    string subformLayoutSet = component["layoutSet"]
                                        ?.GetValue<string>();
                                    ...
                                    {
                                        Reference updatedReference =
                                            updatedLayoutsSets.FirstOrDefault(item =>
                                ...
                                case "Summary2":
                                    if (component["target"] is JsonObject target)
                                    {
                                        ...
                                        string layoutSetId = string.IsNullOrEmpty(taskId)
                                            ...
                                            : layoutSets
                                                ?.FirstOrDefault(item =>
                                                    item.Tasks?.Contains(taskId) ?? false
                                                )
                                                ?.Id;
                                        ...
                                        else
                                        {
                                            ...
                                            switch (type)
                                            {
                                                case "page":
                                                    updatedReference =
                                                        updatedLayouts.FirstOrDefault(item =>
                                                            item.LayoutSetName == layoutSetId
                                                            && item.Id == id
                                                        );
                                                    break;
                                                case "component":
                                                    updatedReference =
                                                        updatedComponents.FirstOrDefault(item =>
                                                            item.LayoutSetName == layoutSetId
                                                            && item.Id == id
                                                        );
                                                    break;
                                            ...
                                            {
                                                updatedReference = updatedTasks.FirstOrDefault(
                                                    item => item.Id == taskId
                                                );
                                                if (updatedReference != null)
                                                {
                                        ...
                                        if (component["overrides"] is JsonArray overrideList)
                                        {
                                            for (int j = overrideList.Count - 1; j >= 0; j--)
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    if (updatedReference != null)
                                                    {
                                                        overrideItem["componentId"] =
                                                            updatedReference.NewId;
                                                        hasLayoutChanges = true;
                                                    }
                                                }
                    ...
                    if (isLayoutSetDeleted || isLayoutDeleted)
                    {
                        ...
                        {
                            referencesToDelete.Add(
                                new Reference(ReferenceType.Layout, layoutSet.Id, layout.Key)
                            );
                        }
            ...
            {
                hasChanges |= await UpdateLayoutReferences(
                    altinnAppGitRepository,
                    layoutSets,
                    referencesToDelete,
                    cancellationToken
