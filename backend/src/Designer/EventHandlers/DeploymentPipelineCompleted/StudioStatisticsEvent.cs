...
public class StudioStatisticsEvent
{
    ...
    public static StudioStatisticsEvent AppDecommissioned { get; } =
        new("AppDecommissioned", "App Decommissioned");
    public static StudioStatisticsEvent AppDeployFailed { get; } =
        new("AppDeployFailed", "App deploy failed");
    public static StudioStatisticsEvent AppUpdateFailed { get; } =
        new("AppUpdateFailed", "App update failed");
