...
public class DeploymentPipelineQueuedHandler : INotificationHandler<Events.DeploymentPipelineQueued>
{
    ...
    public async Task Handle(
        Events.DeploymentPipelineQueued notification,
    ...
    )
    {
        ...
        var jobData = new JobDataMap
        {
            ...
            },
            {
                ...
                notification.BuildId.ToString()
            },
            {
                DeploymentPipelinePollingJobConstants.Arguments.PipelineType,
                notification.PipelineType.ToString()
            },
            {
        ...
        var job = JobBuilder
            ...
            .WithIdentity(
                DeploymentPipelinePollingJobConstants.JobIdentity(
        ...
        var trigger = TriggerBuilder
            ...
            .WithSimpleSchedule(x =>
                x.WithIntervalInSeconds(
                        DeploymentPipelinePollingJobConstants.PollingIntervalInSeconds
                    )
                    .RepeatForever()
            )
            .Build();
