    ...
    public static class AuthenticationConfiguration
    {
        ...
        )
        {
            var oidcSettings = configuration
                .GetSection(nameof(OidcLoginSettings))
                .Get<OidcLoginSettings>();
            if (
            ...
            )
            {
                throw new ArgumentException(
                    "ClientId or ClientSecret is missing in the configuration"
                );
            }
        ...
        private static bool TryGetClientSecretFromRootDotEnvFile(
            out string clientId,
        ...
        )
        {
            ...
            var keys = DotNetEnv
                .Env.Load(
                    AltinnStudioRepositoryScanner.FindRootDotEnvFilePath(),
