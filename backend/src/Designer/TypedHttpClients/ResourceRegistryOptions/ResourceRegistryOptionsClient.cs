    ...
    public class ResourceRegistryOptionsClients : IResourceRegistryOptions
    {
        ...
        public async Task<LosTerms> GetLosTerms()
        {
            ...
            try
            {
                ...
                losTerms = System.Text.Json.JsonSerializer.Deserialize<LosTerms>(sectorscontent, new System.Text.Json.JsonSerializerOptions() { PropertyNamingPolicy = System.Text.Json.JsonNamingPolicy.CamelCase });
                return losTerms;
            }
            catch (Exception ex)
            {
