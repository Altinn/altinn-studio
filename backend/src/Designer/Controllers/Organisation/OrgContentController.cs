...
public class OrgContentController : ControllerBase
{
    ...
    public async Task<ActionResult<List<LibraryContentReference>>> GetOrgLibraryContentReferences([FromRoute] string orgName, [FromQuery] string contentType, CancellationToken cancellationToken = default)
    {
        ...
        {
            return await _orgContentService.GetOrgContentReferences(null, editingContext);
        }
        ...
        return await _orgContentService.GetOrgContentReferences(parsedContentType, editingContext);
    }
