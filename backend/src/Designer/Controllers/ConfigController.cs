...
namespace Altinn.Studio.Designer.Controllers
{
    ...
    [Route(
        "designer/api/{org}/{app:regex(^(?!datamodels$)[[a-z]][[a-z0-9-]]{{1,28}}[[a-z0-9]]$)}/config"
    )]
    public class ConfigController : Controller
    {
        ...
        public async Task SetServiceConfig(string org, string app, [FromBody] dynamic serviceConfig)
        {
            ServiceConfiguration serviceConfigurationObject =
                await _applicationMetadataService.GetAppMetadataConfigAsync(org, app);
            serviceConfigurationObject.ServiceDescription =
                serviceConfig.serviceDescription.ToString();
            ...
            await _applicationMetadataService.UpdateAppMetadataConfigAsync(
                org,
                app,
            ...
            await _textsService.UpdateTextsForKeys(
                ...
                {
                    { "appName", serviceConfig.serviceName.ToString() },
                },
                "nb"
            );
