...
namespace DataModeling.Tests.Json
{
    public class JsonSchemaSeresAnalyzerTests
    {
        ...
        [InlineData(
            @"Model/JsonSchema/Seres/SeresBasicSchema.json",
            "#/oneOf/[0]",
            "Schema has $ref keyword which in turn has properties"
        )]
        [InlineData(
        ...
        [InlineData(
            ...
            "#",
            "Nested $ref. Schema has a $ref keyword which points to a type which also has a $ref keyword which in turn points to a type which has properties."
        )]
        public void IsValidComplexType_ComplexType_ShouldReturnTrue(
            string path,
            string jsonPointer,
            string testCase
        )
        ...
        [InlineData(
            ...
            "#/$defs/melding-modell/allOf/[0]/properties/a1",
            "Schema has complex type with attributes. Property a1 is an attribute."
        )]
        [InlineData(
            @"Model/JsonSchema/Seres/SeresWithAttributes.json",
            "#/$defs/melding-modell/allOf/[0]/properties/a2",
            "Schema has complex type with attributes. Property a2 is an attribute."
        )]
        [InlineData(
            @"Model/JsonSchema/Seres/SeresWithAttributes.json",
            "#/$defs/melding-modell/allOf/[0]/properties/a3",
            "Schema has complex type with attributes. Property a3 is an attribute."
        )]
        [InlineData(
            @"Model/JsonSchema/Seres/SeresWithAttributes.json",
            "#/$defs/melding-modell/allOf/[0]/properties/a4",
            "Schema has complex type with attributes. Property a4 is an attribute."
        )]
        public void IsValidAttribute_Attribute_ShouldReturnTrue(
            string path,
            string jsonPointer,
            string testCase
        )
        ...
        [InlineData(
            @"Model/JsonSchema/General/NillableAttribute.json",
            "#/$defs/main/properties/nilstring",
            "Schema (nillstring) has a multiple Json value types allowed, including null."
        )]
        public void IsValidNillableAttribute_NillableAttribute_ShouldReturnTrue(
            string path,
            string jsonPointer,
            string testCase
        )
