...
namespace DataModeling.Tests.Json
{
    public class SeresConverterTests
    {
        ...
        [InlineData(
            @"Model/JsonSchema/General/SimpleContentExtensionPlain.json",
            @"Model/XmlSchema/General/SimpleContentExtensionPlain.xsd"
        )]
        [InlineData(
            @"Model/JsonSchema/Seres/SeresBuiltinTypes.json",
            @"Model/XmlSchema/Seres/SeresBuiltinTypes.xsd"
        )]
        [InlineData(
        ...
        [InlineData(
            ...
            @"Model/XmlSchema/Seres/SeresSimpleContentRestriction.fromJson.xsd"
        )]
        ...
        private static async Task<string> Serialize(XmlSchema actualXsd)
        {
            ...
            await using (
                var xw = XmlWriter.Create(sw, new XmlWriterSettings { Indent = true, Async = true })
            )
            {
                actualXsd.Write(xw);
