...
namespace Designer.Tests.Helpers
{
    public class PolicyHelperTests : IDisposable
    {
        ...
        [Theory]
        [InlineData(
            "brg_rrh-innrapportering.xml",
            "brg_rrh-innrapportering_converted.xml",
            "brg_rrh-innrapportering_converted.json"
        )]
        [InlineData(
            "ssb_ra1000-01.xml",
            "ssb_ra1000-01_converted.xml",
            "ssb_ra1000-01_converted.json"
        )]
        [InlineData(
            "krt_krt-1012a-1.xml",
            "krt_krt-1012a-1_converted.xml",
            "krt_krt-1012a-1_converted.json"
        )]
        [InlineData(
            "hmrhf_newsamhandlingsavik.xml",
            "hmrhf_newsamhandlingsavik_converted.xml",
            "hmrhf_newsamhandlingsavik_converted.json"
        )]
        [InlineData(
            "dsb_uhell_med_eksplosiver.xml",
            "dsb_uhell_med_eksplosiver_converted.xml",
            "dsb_uhell_med_eksplosiver_converted.json"
        )]
        [InlineData(
            "skd_sirius_skattemelding_sit_tk.xml",
            "skd_sirius_skattemelding_sit_tk_converted.xml",
            "skd_sirius_skattemelding_sit_tk_converted.json"
        )]
        [InlineData(
            "skd_mva-melding-innsending-v1.xml",
            "skd_mva-melding-innsending-v1_converted.xml",
            "skd_mva-melding-innsending-v1.json"
        )]
        [InlineData(
            "resource_registry_delegatableapi.xml",
            "resource_registry_delegatableapi_converted.xml",
            "resource_registry_delegatableapi.json"
        )]
        public void TestXacmlToJson(
            string xmlPolicy,
            string convertedXamlPolicyName,
            string convertedJsonPolicyName
        )
        {
        ...
        public void Dispose()
        {
            string xmlPath = Path.Combine(
                AuthorizationUtil.GetPolicyPath(),
                _convertedXmlPolicyName
            );
            string jsonPath = Path.Combine(
                AuthorizationUtil.GetPolicyPath(),
                _convertedJsonPolicyName
            );
