...
public class GitDiffIntegrationTests : GiteaIntegrationTestsBase<GitDiffIntegrationTests>
{
    ...
    public async Task GetGitDiff_ShouldReturnOkWithDiff(string org)
    {
        ...
        var updateLayoutSetNameResponse = await HttpClient.SendAsync(
            httpRequestMessageWithNewLayoutSetName
        );
        ...
        using var httpRequestMessageGetGitDiff = new HttpRequestMessage(
            HttpMethod.Get,
            getGitDiffUrl
        );
