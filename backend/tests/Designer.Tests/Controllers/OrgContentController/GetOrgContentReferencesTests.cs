        ...
        IClassFixture<WebApplicationFactory<Program>>
{
    ...
    {
        string[] codeListFileNames = TestDataHelper.GetRepositoryFileNames(Developer, SourceOrgName, SourceRepoName, "CodeLists/");
        string[] textResourceFileNames = TestDataHelper.GetRepositoryFileNames(Developer, SourceOrgName, SourceRepoName, "Texts/");
        ...
        {
            string file = TestDataHelper.GetFileFromRepo(SourceOrgName, SourceRepoName, Developer, fileName);
