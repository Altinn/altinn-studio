...
public class DeleteDatamodelTests
    : DesignerEndpointsTestsBase<DeleteDatamodelTests>,
        IClassFixture<WebApplicationFactory<Program>>
{
    ...
    public DeleteDatamodelTests(WebApplicationFactory<Program> factory)
        : base(factory)
    {
    ...
    public async Task Delete_Datamodel_FromDataModelRepo_Ok(
        string org,
        string repo,
        string modelPath
    )
    ...
    public async Task Delete_Datamodel_FromAppWhereDataModelHasMultipleLayoutSetConnections_Ok(
        string org,
        string repo,
        string developer,
        string modelPath
    )
    {
        ...
        string applicationMetadataFromRepoBefore = TestDataHelper.GetFileFromRepo(
            org,
            targetRepository,
            developer,
            "App/config/applicationmetadata.json"
        );
        string layoutSetsFromRepoBefore = TestDataHelper.GetFileFromRepo(
            org,
            targetRepository,
            developer,
        ...
        string applicationMetadataFromRepoAfter = TestDataHelper.GetFileFromRepo(
            org,
            targetRepository,
            developer,
            "App/config/applicationmetadata.json"
        );
        string layoutSetsFromRepoAfter = TestDataHelper.GetFileFromRepo(
            org,
            targetRepository,
            developer,
            "App/ui/layout-sets.json"
