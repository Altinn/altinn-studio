...
public class GetImageByNameTests
    : DesignerEndpointsTestsBase<GetImageByNameTests>,
        IClassFixture<WebApplicationFactory<Program>>
{
    ...
    public GetImageByNameTests(WebApplicationFactory<Program> factory)
        : base(factory) { }
    ...
    public async Task GetImageByName_WhenImageExistsInSubFolder_ReturnsImageAsFileStreamResult()
    {
        ...
        string encodedImageFilePath = Uri.EscapeDataString(relativeImageFilePath)
            .Replace("/", "%2F");
