...
{
    public class ProcessNextTests : PreviewControllerTestsBase<ProcessNextTests>
    {

        public ProcessNextTests(WebApplicationFactory<Altinn.Studio.Designer.Controllers.PreviewController> factory) : base(factory)
        {
        }
