...
{
    public class GetAppVersionTests
        : DesignerEndpointsTestsBase<GetAppVersionTests>,
            IClassFixture<WebApplicationFactory<Program>>
    {
        private static string VersionPrefix(string org, string repository) =>
            $"/designer/api/{org}/{repository}/app-development/app-version";

        public GetAppVersionTests(WebApplicationFactory<Program> factory)
            : base(factory) { }
        ...
        [InlineData(
            ...
            "7.4.0",
            "3.1.12",
            "Templates/AppCsprojTemplate.txt",
            "Templates/Index.cshtml.txt"
        )]
        [InlineData(
            "ttd",
            "empty-app",
        ...
        public async Task GetAppVersion_GivenCsProjFile_ShouldReturnOK(
            string org,
            string app,
            string developer,
        ...
        public async Task GetAppVersion_GivenCsprojFileWithoutAppLib_ShouldReturn404(
            string org,
            string app,
            string developer,
            string csprojTemplate
        ...
        public async Task GetAppVersion_NotGivenIndexFile_ShouldReturnNullAsVersion(
            string org,
            string app,
            string developer,
            string backendVersion,
        ...
        [InlineData(
            ...
            "8.0.0-preview.11",
            "Templates/AppCsprojTemplate.txt",
            "Templates/IndexWithoutFrontendVersion.cshtml.txt"
        )]
        public async Task GetAppVersion_GivenIndexFileWithoutFrontendVersion_ShouldReturnNullAsVersion(
            string org,
            string app,
            string developer,
            string backendVersion,
        ...
        private async Task AddCsProjToRepo(
        ...
        private Task AddFrontendIndexToRepo(
            string relativeCopyRepoLocation,
