...
{
    public class SaveRuleConfigTests
        : DesignerEndpointsTestsBase<SaveRuleConfigTests>,
            IClassFixture<WebApplicationFactory<Program>>
    {
        private static string VersionPrefix(string org, string repository) =>
            $"/designer/api/{org}/{repository}/app-development";

        public SaveRuleConfigTests(WebApplicationFactory<Program> factory)
            : base(factory) { }
        ...
        )
        {
            ...
            string url =
                $"{VersionPrefix(org, targetRepository)}/rule-config?layoutSetName={layoutSetName}";
