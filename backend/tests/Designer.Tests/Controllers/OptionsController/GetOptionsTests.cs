        ...
        IClassFixture<WebApplicationFactory<Program>>
{
    ...
    public async Task GetOptionLists_Returns200OK_WithOptionListsData()
    {
        ...
        string optionListTrailingComma =
        ...
        await File.WriteAllTextAsync(
            Path.Combine(filePath, "optionListMissingValue.json"),
            optionListMissingValue
        );
        await File.WriteAllTextAsync(
            Path.Combine(filePath, "optionListMissingLabel.json"),
            optionListMissingLabel
        );
        await File.WriteAllTextAsync(
            Path.Combine(filePath, "optionListTrailingComma.json"),
            optionListTrailingComma
        );
        await File.WriteAllTextAsync(
        ...
        await File.WriteAllTextAsync(
            Path.Combine(filePath, "optionListLabelWithBool.json"),
            optionListLabelWithBool
        );
        ...
        Assert.Single(
            responseList,
            o => o.Title == "options-with-null-fields" && o.HasError == true
        );
        ...
        Assert.Single(
            responseList,
            o => o.Title == "optionListTrailingComma" && o.HasError == true
        );
        Assert.Single(
            responseList,
            o => o.Title == "optionListLabelWithObject" && o.HasError == true
        );
        Assert.Single(
            responseList,
            o => o.Title == "optionListLabelWithNumber" && o.HasError == true
        );
        Assert.Single(
            responseList,
            o => o.Title == "optionListLabelWithBool" && o.HasError == true
        );
    }
