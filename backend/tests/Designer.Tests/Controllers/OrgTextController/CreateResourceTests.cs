...
public class CreateResourceTests
    : DesignerEndpointsTestsBase<CreateResourceTests>,
        IClassFixture<WebApplicationFactory<Program>>
{
    public CreateResourceTests(WebApplicationFactory<Program> factory)
        : base(factory) { }
    ...
    public async Task CreateResource_Returns200Ok_WithValidInput(
        string org,
        string developer,
        string repo,
        string lang,
