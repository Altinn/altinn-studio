...
{
    public class ValidateAppPolicyTests
        : DesignerEndpointsTestsBase<ValidateAppPolicyTests>,
            IClassFixture<WebApplicationFactory<Program>>
    {
        private readonly string _versionPrefix = "designer/api";

        public ValidateAppPolicyTests(WebApplicationFactory<Program> factory)
            : base(factory) { }
        ...
        public async Task Validate_AppPolicyOk()
        {
            ...
            )
            {
                ...
                validationDetails =
                    System.Text.Json.JsonSerializer.Deserialize<ValidationProblemDetails>(
                        responseBody,
        ...
        public async Task Validate_AppPolicyMissingSubject()
        {
            ...
            ValidationProblemDetails validationDetails;
            using (
                HttpRequestMessage httpRequestMessage3 = new HttpRequestMessage(
                    HttpMethod.Get,
                    dataPathWithData3
                )
            )
