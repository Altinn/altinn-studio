...
using Designer.Tests.Controllers.ResourceAdminController;
...
public class SetServiceEditionExpired : ResourceAdminControllerTestsBaseClass<SetServiceEditionExpired>, IClassFixture<WebApplicationFactory<Program>>
{
    ...
    public SetServiceEditionExpired(WebApplicationFactory<Program> factory) : base(factory)
    {
