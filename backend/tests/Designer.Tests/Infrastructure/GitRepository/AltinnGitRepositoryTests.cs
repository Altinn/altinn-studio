...
namespace Designer.Tests.Infrastructure.GitRepository
{
    public class AltinnGitRepositoryTests
    {
        ...
        [InlineData(
            ...
            "repoName",
            "developerName",
            @"c:\there should not be anything here either",
            ""
        )]
        [InlineData(
            "orgCode",
        ...
        public void Constructor_InValidParametersCorrectPath_ShouldFail(
            string org,
            string repository,
            string developer
        )
        ...
        )
        {
            ...
            Assert.Contains(
                repositoriesRootDirectory,
                altinnGitRepository.RepositoriesRootDirectory
            );
        }
        ...
        public async Task RepositoryType_SettingsExists_ShouldUseThat()
        {
            ...
            Assert.Equal(
                ...
                await altinnGitRepository.GetRepositoryType()
            );
        }
            ...
            try
            {
                ...
                Assert.True(
                    altinnGitRepository.FileExistsByRelativePath(
                        Path.Combine(".altinnstudio", "settings.json")
                    )
                );
            }
            finally
        ...
        private static AltinnGitRepository GetTestRepository(
            string org,
            string repository,
            string developer
        )
