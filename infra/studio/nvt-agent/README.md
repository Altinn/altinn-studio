...
The public chart is pinned to `0.8.8` (verified OCI digest
`sha256:3f917bd1006d43d6e0eb2399483c327f15255384bab795ba1da6cad8ead89172`),
using the Flux v1 OCIRepository `ref.digest` selector rather than its mutable
tag. It resolves the coordinated `0.8.8-fb7ba41` production images without
