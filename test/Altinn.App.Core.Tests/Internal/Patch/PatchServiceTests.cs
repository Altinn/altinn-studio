...
public class PatchServiceTests
{
    ...
    {
        _appMetadataMock.Setup(a => a.GetApplicationMetadata()).ReturnsAsync(new ApplicationMetadata("ttd/test")).Verifiable();
        _appModelMock.Setup(a => a.GetModelType("Altinn.App.Core.Tests.Internal.Patch.PatchServiceTests+MyModel")).Returns(typeof(MyModel)).Verifiable();
        ...
        _dataClientMock.Setup(d => d.UpdateData<object>(It.IsAny<MyModel>(), It.IsAny<Guid>(), It.IsAny<Type>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<Guid>())).ReturnsAsync(_dataElement).Verifiable();
    ...
    private readonly DataType _dataType = new()
    {
        ...
        AppLogic = new()
        {
            ClassRef = "Altinn.App.Core.Tests.Internal.Patch.PatchServiceTests+MyModel"
        }
    };
    ...
    public async Task Test_Ok()
    {
        ...
        // Act
        var response = await _patchService.ApplyPatch(_instance, _dataType, _dataElement, jsonPatch, null, ignoredValidators);
